...
<link crossorigin="anonymous" media="all" rel="stylesheet" href="https://github.githubassets.com/assets/react-code-view.234ae39ff1fa1232236c.module.css" />
  ...
  <title>FastAPI_TDD/fastapi_tdd/main.py at main · danielmarcosvilela/FastAPI_TDD</title>
  ...
  <meta name="request-id" content="62E8:2F9AFB:4D98F5:544882:668DE159" data-turbo-transient="true" /><meta name="html-safe-nonce" content="f8867c2128ae1a2f1350c72a96d0127f74529d5a6c985793258613fe2360e2c0" data-turbo-transient="true" /><meta name="visitor-payload" content="" data-turbo-transient="true" /><meta name="visitor-hmac" content="5884cebef90a6e242ad2954da7affaf1b1687bc27e36704a549b9ecaf2ac8f59" data-turbo-transient="true" />
...
<meta name="octolytics-url" content="https://collector.github.com/github/collect" /><meta name="octolytics-actor-id" content="169305262" /><meta name="octolytics-actor-login" content="adrianobodnar" /><meta name="octolytics-actor-hash" content="da544cd792fa1452e5d2abecdf3ddf3954e802e6a8c16649340a1280512e432b" />
  ...
  <link rel="sudo-modal" href="/sessions/sudo_modal">
    ...
    <meta name="apple-itunes-app" content="app-id=1477376905, app-argument=https://github.com/danielmarcosvilela/FastAPI_TDD/blob/main/fastapi_tdd/main.py" />

      <meta name="twitter:image:src" content="https://opengraph.githubassets.com/2f3d655158b26cb2701a05ec38619a14ad7c312e034454b1619e168f7d34834d/danielmarcosvilela/FastAPI_TDD" /><meta name="twitter:site" content="@github" /><meta name="twitter:card" content="summary_large_image" /><meta name="twitter:title" content="FastAPI_TDD/fastapi_tdd/main.py at main · danielmarcosvilela/FastAPI_TDD" /><meta name="twitter:description" content="Criando Uma API Com FastAPI Utilizando TDD. Contribute to danielmarcosvilela/FastAPI_TDD development by creating an account on GitHub." />
  <meta property="og:image" content="https://opengraph.githubassets.com/2f3d655158b26cb2701a05ec38619a14ad7c312e034454b1619e168f7d34834d/danielmarcosvilela/FastAPI_TDD" /><meta property="og:image:alt" content="Criando Uma API Com FastAPI Utilizando TDD. Contribute to danielmarcosvilela/FastAPI_TDD development by creating an account on GitHub." /><meta property="og:image:width" content="1200" /><meta property="og:image:height" content="600" /><meta property="og:site_name" content="GitHub" /><meta property="og:type" content="object" /><meta property="og:title" content="FastAPI_TDD/fastapi_tdd/main.py at main · danielmarcosvilela/FastAPI_TDD" /><meta property="og:url" content="https://github.com/danielmarcosvilela/FastAPI_TDD/blob/main/fastapi_tdd/main.py" /><meta property="og:description" content="Criando Uma API Com FastAPI Utilizando TDD. Contribute to danielmarcosvilela/FastAPI_TDD development by creating an account on GitHub." />
  


      <link rel="shared-web-socket" href="wss://alive.github.com/_sockets/u/169305262/ws?session=eyJ2IjoiVjMiLCJ1IjoxNjkzMDUyNjIsInMiOjEzNzY0MTk4NDYsImMiOjE0NjQxMjc0OTIsInQiOjE3MjA1NzQzMDR9--f5d4a151939c4667bc1bdf4d5bbb0e180346c8a24099a7dd0f596cd84949a553" data-refresh-url="/_alive" data-session-id="342bf16456046948c5ebe94701ed19d497595272803f04c14b39f62bc6d40c1f">
...
>
  ...
  <include-fragment data-target="deferred-side-panel.fragment">
      <button aria-label="Open global navigation menu" data-action="click:deferred-side-panel#loadPanel click:deferred-side-panel#panelOpened" data-show-dialog-id="dialog-80385a74-ef7a-47c4-b77d-09db4638b6f4" id="dialog-show-dialog-80385a74-ef7a-47c4-b77d-09db4638b6f4" type="button" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button color-bg-transparent p-0 color-fg-muted">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-three-bars Button-visual">
    <path d="M1 2.75A.75.75 0 0 1 1.75 2h12.5a.75.75 0 0 1 0 1.5H1.75A.75.75 0 0 1 1 2.75Zm0 5A.75.75 0 0 1 1.75 7h12.5a.75.75 0 0 1 0 1.5H1.75A.75.75 0 0 1 1 7.75ZM1.75 12h12.5a.75.75 0 0 1 0 1.5H1.75a.75.75 0 0 1 0-1.5Z"></path>
</svg>
</button>

<dialog-helper>
  <dialog data-target="deferred-side-panel.panel" id="dialog-80385a74-ef7a-47c4-b77d-09db4638b6f4" aria-modal="true" aria-labelledby="dialog-80385a74-ef7a-47c4-b77d-09db4638b6f4-title" aria-describedby="dialog-80385a74-ef7a-47c4-b77d-09db4638b6f4-description" data-view-component="true" class="Overlay Overlay-whenNarrow Overlay--size-small-portrait Overlay--motion-scaleFade Overlay--placement-left SidePanel">
    <div styles="flex-direction: row;" data-view-component="true" class="Overlay-header">
  <div class="Overlay-headerContentWrap">
    <div class="Overlay-titleWrap">
      <h1 class="Overlay-title sr-only" id="dialog-80385a74-ef7a-47c4-b77d-09db4638b6f4-title">
        Global navigation
      </h1>
    ...
    <div class="Overlay-actionWrap">
      <button data-close-dialog-id="dialog-80385a74-ef7a-47c4-b77d-09db4638b6f4" aria-label="Close" type="button" data-view-component="true" class="close-button Overlay-closeButton"><svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="dialog-80385a74-ef7a-47c4-b77d-09db4638b6f4-title">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g d" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;HOME&quot;,&quot;label&quot;:null}" id="item-a8ee92fb-66a0-4fcb-95ae-20f5eba8eb5d" href="/dashboard" data-view-component="true" class="ActionListContent ActionListContent--visual16">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g i" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;ISSUES&quot;,&quot;label&quot;:null}" id="item-f8db7926-f192-4a9c-ad30-5069ee132571" href="/issues" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g p" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PULL_REQUESTS&quot;,&quot;label&quot;:null}" id="item-f1167464-09e4-4cc5-b8ef-0e6b29190e21" href="/pulls" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-item-id="projects" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PROJECTS&quot;,&quot;label&quot;:null}" id="item-cf66a720-14c1-4fb5-97d3-f4e24e05d395" href="/projects" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;DISCUSSIONS&quot;,&quot;label&quot;:null}" id="item-a8c988d4-d41d-4a38-9108-2f8f16ae7e55" href="/discussions" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;CODESPACES&quot;,&quot;label&quot;:null}" id="item-1b81138b-7ea8-43d5-a8de-c0bdf84f0e3a" href="https://github.com/codespaces" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;EXPLORE&quot;,&quot;label&quot;:null}" id="item-91570d12-d9db-4dbe-ad1e-ba5f6bc6268a" href="/explore" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;MARKETPLACE&quot;,&quot;label&quot;:null}" id="item-90d3e874-93cd-4ef9-bba6-097698e91546" href="/marketplace" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<qbsearch-input class="search-input" data-scope="repo:danielmarcosvilela/FastAPI_TDD" data-custom-scopes-path="/search/custom_scopes" data-delete-custom-scopes-csrf="MD7Mh6j4-r_UfwX_pcHyNRYJds2FZsoGSeryVlkhBZO42asp4t0ZHYMeKZzUJj1EoQuuXHGERj8xCPX5Njke7A" data-max-custom-scopes="10" data-header-redesign-enabled="true" data-initial-value="" data-blackbird-suggestions-path="/search/suggestions" data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations" data-current-repository="danielmarcosvilela/FastAPI_TDD" data-current-org="" data-current-owner="danielmarcosvilela" data-logged-in="true" data-copilot-chat-enabled="false" data-blackbird-indexed-repo-csrf="<input type=&quot;hidden&quot; value=&quot;kpNJbKLrF_D3HwX9LOzuFIjGgTphlwyACFnVHi2K3nzIxyXSb-pMGqbFi237mBdakf5Rbv4YdSLyjkn8QN-jrA&quot; data-csrf=&quot;true&quot; />" data-nl-search-enabled="false">
  <div
    ...
    <path d="M10.68 11.74a6 6 0 0 1-7.922-8.982 6 6 0 0 1 8.982 7.922l3.04 3.04a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215ZM11.5 7a4.499 4.499 0 1 0-8.997 0A4.499 4.499 0 0 0 11.5 7Z"></path>
        ...
        <div data-target="query-builder.styledInputContainer" class="QueryBuilder-StyledInputContainer">
          ...
          <div class="QueryBuilder-InputWrapper">
            ...
            <input id="query-builder-test" name="query-builder-test" value="" autocomplete="off" type="text" role="combobox" spellcheck="false" aria-expanded="false" aria-describedby="validation-9ab1f029-6079-49da-988a-f3a30a052455" data-target="query-builder.input" data-action="
...
<template id="device-desktop-icon">
  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-device-desktop">
    <path d="M14.25 1c.966 0 1.75.784 1.75 1.75v7.5A1.75 1.75 0 0 1 14.25 12h-3.727c.099 1.041.52 1.872 1.292 2.757A.752.752 0 0 1 11.25 16h-6.5a.75.75 0 0 1-.565-1.243c.772-.885 1.192-1.716 1.292-2.757H1.75A1.75 1.75 0 0 1 0 10.25v-7.5C0 1.784.784 1 1.75 1ZM1.75 2.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25ZM9.018 12H6.982a5.72 5.72 0 0 1-.765 2.5h3.566a5.72 5.72 0 0 1-.765-2.5Z"></path>
      ...
      <div class="FormControl-inlineValidation" id="validation-9ab1f029-6079-49da-988a-f3a30a052455" hidden="hidden">
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="feedback-dialog-title">
        <div data-view-component="true" class="Overlay-body">        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="code-search-feedback-form" data-turbo="false" action="/search/feedback" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="uNDulSbdRoN6flrEpgDX2WkjB4FglzGUZemLBl7hwmI6c-Uhd6XNlfpRo-JacAFXOb3FprG-y9Rmnu-gfOT_cw" />
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="custom-scopes-dialog-title">
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="custom-scopes-dialog-form" data-turbo="false" action="/search/custom_scopes" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="Zp9gYpRJ1QvW6YFRx0_P3vcg-ktW04-A00Sft4i61w1UpnAswU97KPEnF0MuKnrBOKppIGbFUCUpUmxE6y_Apw" />
          ...
          <div class="form-group">
            ...
            <auto-check src="/search/custom_scopes/check_name" required>
              <input
                ...
                required
                maxlength="50">
              <input type="hidden" value="4ViArsjyVcjZx4Mj1DnJJvVrti1DAY6VDQ6jS2tiorMCcnXK1pWr_YjA0b1dMBOuadaSxe_ksbr6T0WMFLkCTg" data-csrf="true" />
            </auto-check>
          </div>
...
</qbsearch-input><input type="hidden" value="KMlRmjKvYveLju7DM38oih6WxpP6uFj5VJ3uY8tpnaXxIHGsBQMB79wg04ba8cjUg0Ol5KXpm5-YGapheQeVkg" data-csrf="true" class="js-data-jump-to-suggestions-path-csrf" />
...
</button><tool-tip id="tooltip-b21e28e1-691e-43c3-977e-52cd296b947a" for="global-create-menu-anchor" popover="manual" data-direction="s" data-type="description" data-view-component="true" class="sr-only position-absolute">Create new...</tool-tip>
...
>
  ...
  <div data-target="react-partial.reactRoot"></div>
          ...
          <a href="/issues" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;ISSUES_HEADER&quot;,&quot;label&quot;:null}" id="icon-button-2d328919-a9ce-4db8-9587-81fe84166926" aria-labelledby="tooltip-4581a89f-bdc9-4d2d-8e62-d03b7480d4c6" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button color-fg-muted">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-issue-opened Button-visual">
    <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
</svg>
</a><tool-tip id="tooltip-4581a89f-bdc9-4d2d-8e62-d03b7480d4c6" for="icon-button-2d328919-a9ce-4db8-9587-81fe84166926" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Issues</tool-tip>

          <a href="/pulls" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PULL_REQUESTS_HEADER&quot;,&quot;label&quot;:null}" id="icon-button-12a3cbdc-727b-4984-beb9-b77c424dbc55" aria-labelledby="tooltip-d1cb6564-b267-45f1-af05-cfbf7a34ac54" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button color-fg-muted">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-git-pull-request Button-visual">
    <path d="M1.5 3.25a2.25 2.25 0 1 1 3 2.122v5.256a2.251 2.251 0 1 1-1.5 0V5.372A2.25 2.25 0 0 1 1.5 3.25Zm5.677-.177L9.573.677A.25.25 0 0 1 10 .854V2.5h1A2.5 2.5 0 0 1 13.5 5v5.628a2.251 2.251 0 1 1-1.5 0V5a1 1 0 0 0-1-1h-1v1.646a.25.25 0 0 1-.427.177L7.177 3.427a.25.25 0 0 1 0-.354ZM3.75 2.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm0 9.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm8.25.75a.75.75 0 1 0 1.5 0 .75.75 0 0 0-1.5 0Z"></path>
</svg>
</a><tool-tip id="tooltip-d1cb6564-b267-45f1-af05-cfbf7a34ac54" for="icon-button-12a3cbdc-727b-4984-beb9-b77c424dbc55" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Pull requests</tool-tip>

        </div>

        <notification-indicator data-channel="eyJjIjoibm90aWZpY2F0aW9uLWNoYW5nZWQ6MTY5MzA1MjYyIiwidCI6MTcyMDU3NDMwNH0=--7caa6b386941d7fcfdab8648f69d935199ef5546151181b7fda0dd604d2efb8f" data-indicator-mode="none" data-tooltip-global="You have unread notifications" data-tooltip-unavailable="Notifications are unavailable at the moment." data-tooltip-none="You have no unread notifications" data-header-redesign-enabled="true" data-fetch-indicator-src="/notifications/indicator" data-fetch-indicator-enabled="true" data-view-component="true" class="js-socket-channel">
...
<site-header-logged-in-user-menu>
  ...
  <focus-group direction="vertical" mnemonics retain>
    <button id="action-menu-b0cd063b-16fa-4ab3-9475-d01f29769418-button" popovertarget="action-menu-b0cd063b-16fa-4ab3-9475-d01f29769418-overlay" aria-controls="action-menu-b0cd063b-16fa-4ab3-9475-d01f29769418-list" aria-haspopup="true" aria-labelledby="tooltip-c22e70f5-b570-47f3-89af-c07022470334" type="button" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium UnderlineNav-item">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-kebab-horizontal Button-visual">
    <path d="M8 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3ZM1.5 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm13 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path>
</svg>
</button><tool-tip id="tooltip-c22e70f5-b570-47f3-89af-c07022470334" for="action-menu-b0cd063b-16fa-4ab3-9475-d01f29769418-button" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Additional navigation options</tool-tip>


<anchored-position id="action-menu-b0cd063b-16fa-4ab3-9475-d01f29769418-overlay" anchor="action-menu-b0cd063b-16fa-4ab3-9475-d01f29769418-button" align="start" side="outside-bottom" anchor-offset="normal" popover="auto" data-view-component="true">
  <div data-view-component="true" class="Overlay Overlay--size-auto">
    
      <div data-view-component="true" class="Overlay-body Overlay-body--paddingNone">          <action-list>
  <div data-view-component="true">
    <ul aria-labelledby="action-menu-b0cd063b-16fa-4ab3-9475-d01f29769418-button" id="action-menu-b0cd063b-16fa-4ab3-9475-d01f29769418-list" role="menu" data-view-component="true" class="ActionListWrap--inset ActionListWrap">
        <li hidden="hidden" data-menu-item="i0code-tab" data-targets="action-list.items" role="none" data-view-component="true" class="ActionListItem">
    
    
    <a tabindex="-1" id="item-d3e7b8f0-9718-419a-a3f1-0a76383072f4" href="/danielmarcosvilela/FastAPI_TDD" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-code">
    <path d="m11.28 3.22 4.25 4.25a.75.75 0 0 1 0 1.06l-4.25 4.25a.749.749 0 0 1-1.275-.326.749.749 0 0 1 .215-.734L13.94 8l-3.72-3.72a.749.749 0 0 1 .326-1.275.749.749 0 0 1 .734.215Zm-6.56 0a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042L2.06 8l3.72 3.72a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L.47 8.53a.75.75 0 0 1 0-1.06Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-7c26defa-9e3b-48a6-a92e-2dcad8324c01" href="/danielmarcosvilela/FastAPI_TDD/issues" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-issue-opened">
    <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-22fd8cc9-4644-4422-a98a-ae85251a4e95" href="/danielmarcosvilela/FastAPI_TDD/pulls" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-git-pull-request">
    <path d="M1.5 3.25a2.25 2.25 0 1 1 3 2.122v5.256a2.251 2.251 0 1 1-1.5 0V5.372A2.25 2.25 0 0 1 1.5 3.25Zm5.677-.177L9.573.677A.25.25 0 0 1 10 .854V2.5h1A2.5 2.5 0 0 1 13.5 5v5.628a2.251 2.251 0 1 1-1.5 0V5a1 1 0 0 0-1-1h-1v1.646a.25.25 0 0 1-.427.177L7.177 3.427a.25.25 0 0 1 0-.354ZM3.75 2.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm0 9.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm8.25.75a.75.75 0 1 0 1.5 0 .75.75 0 0 0-1.5 0Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-1e415865-4839-4339-bc6b-6dc55845584f" href="/danielmarcosvilela/FastAPI_TDD/actions" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-play">
    <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Zm4.879-2.773 4.264 2.559a.25.25 0 0 1 0 .428l-4.264 2.559A.25.25 0 0 1 6 10.559V5.442a.25.25 0 0 1 .379-.215Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-ef041316-d843-4ca1-adc4-9edd5f414ce5" href="/danielmarcosvilela/FastAPI_TDD/projects" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-table">
    <path d="M0 1.75C0 .784.784 0 1.75 0h12.5C15.216 0 16 .784 16 1.75v12.5A1.75 1.75 0 0 1 14.25 16H1.75A1.75 1.75 0 0 1 0 14.25ZM6.5 6.5v8h7.75a.25.25 0 0 0 .25-.25V6.5Zm8-1.5V1.75a.25.25 0 0 0-.25-.25H6.5V5Zm-13 1.5v7.75c0 .138.112.25.25.25H5v-8ZM5 5V1.5H1.75a.25.25 0 0 0-.25.25V5Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-9626da9f-f45e-48ac-8b8b-5e68715bd3a1" href="/danielmarcosvilela/FastAPI_TDD/security" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-31c290d5-776d-4be4-b6fa-c3a6e99be61a" href="/danielmarcosvilela/FastAPI_TDD/pulse" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <button id="icon-button-ab5f9fcc-ae28-4b61-9a05-0a92f95743e8" aria-labelledby="tooltip-9797dee2-ca0c-4069-9ffd-46580cf71e6a" type="button" data-view-component="true" class="Button Button--iconOnly Button--invisible Button--medium flash-close js-flash-close">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x Button-visual">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
</svg>
</button><tool-tip id="tooltip-9797dee2-ca0c-4069-9ffd-46580cf71e6a" for="icon-button-ab5f9fcc-ae28-4b61-9a05-0a92f95743e8" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Dismiss alert</tool-tip>
...
<div class="flash flash-full   {{ className }}">
  <div >
    ...
    <notification-shelf-watcher data-base-url="https://github.com/notifications/beta/shelf" data-channel="eyJjIjoibm90aWZpY2F0aW9uLWNoYW5nZWQ6MTY5MzA1MjYyIiwidCI6MTcyMDU3NDMwNX0=--b9c58c9a49fc5b435335dcaa123e4e24653c421c8e01ceec1d6b44f617bbeb69" data-view-component="true" class="js-socket-channel"></notification-shelf-watcher>
...
<react-app
  ...
  initial-path="/danielmarcosvilela/FastAPI_TDD/blob/main/fastapi_tdd/main.py"
...
>
  ...
  <script type="application/json" data-target="react-app.embeddedData">{"payload":{"allShortcutsEnabled":true,"fileTree":{"fastapi_tdd":{"items":[{"name":"__pycache__","path":"fastapi_tdd/__pycache__","contentType":"directory"},{"name":"controllers","path":"fastapi_tdd/controllers","contentType":"directory"},{"name":"core","path":"fastapi_tdd/core","contentType":"directory"},{"name":"db","path":"fastapi_tdd/db","contentType":"directory"},{"name":"models","path":"fastapi_tdd/models","contentType":"directory"},{"name":"schemas","path":"fastapi_tdd/schemas","contentType":"directory"},{"name":"usecases","path":"fastapi_tdd/usecases","contentType":"directory"},{"name":"__init__.py","path":"fastapi_tdd/__init__.py","contentType":"file"},{"name":"main.py","path":"fastapi_tdd/main.py","contentType":"file"},{"name":"routers.py","path":"fastapi_tdd/routers.py","contentType":"file"}],"totalCount":10},"":{"items":[{"name":"fastapi_tdd","path":"fastapi_tdd","contentType":"directory"},{"name":"tests","path":"tests","contentType":"directory"},{"name":".env","path":".env","contentType":"file"},{"name":".pre-commit-config.yaml","path":".pre-commit-config.yaml","contentType":"file"},{"name":".python-version","path":".python-version","contentType":"file"},{"name":"Makefile","path":"Makefile","contentType":"file"},{"name":"README.md","path":"README.md","contentType":"file"},{"name":"docker-compose.yml","path":"docker-compose.yml","contentType":"file"},{"name":"poetry.lock","path":"poetry.lock","contentType":"file"},{"name":"pyproject.toml","path":"pyproject.toml","contentType":"file"}],"totalCount":10}},"fileTreeProcessingTime":2.792963,"foldersToFetch":[],"repo":{"id":793583549,"defaultBranch":"main","name":"FastAPI_TDD","ownerLogin":"danielmarcosvilela","currentUserCanPush":false,"isFork":false,"isEmpty":false,"createdAt":"2024-04-29T10:49:44.000-03:00","ownerAvatar":"https://avatars.githubusercontent.com/u/83494779?v=4","public":true,"private":false,"isOrgOwned":false},"codeLineWrapEnabled":false,"symbolsExpanded":true,"treeExpanded":true,"refInfo":{"name":"main","listCacheKey":"v0:1714484464.0","canEdit":true,"refType":"branch","currentOid":"aaebd12f7d696b078140cbf032144aea34ab2d40"},"path":"fastapi_tdd/main.py","currentUser":{"id":169305262,"login":"adrianobodnar","userEmail":"adrianobod@gmail.com"},"blob":{"rawLines":["from fastapi import FastAPI","from fastapi_tdd.core.config import settings","from fastapi_tdd.routers import api_router","","","class App(FastAPI):","    def __init__(self, *args, **kwargs) -\u003e None:","        super().__init__(","            *args,","            **kwargs,","            version=\"0.1.0\",","            title=settings.PROJECT_NAME,","            root_path=settings.ROOT_PATH","        )","","","app = App()","app.include_router(api_router)"],"stylingDirectives":null,"colorizedLines":["\u003cspan class=pl-k\u003efrom\u003c/span\u003e \u003cspan class=pl-s1\u003efastapi\u003c/span\u003e \u003cspan class=pl-k\u003eimport\u003c/span\u003e \u003cspan class=pl-v\u003eFastAPI\u003c/span\u003e","\u003cspan class=pl-k\u003efrom\u003c/span\u003e \u003cspan class=pl-s1\u003efastapi_tdd\u003c/span\u003e.\u003cspan class=pl-s1\u003ecore\u003c/span\u003e.\u003cspan class=pl-s1\u003econfig\u003c/span\u003e \u003cspan class=pl-k\u003eimport\u003c/span\u003e \u003cspan class=pl-s1\u003esettings\u003c/span\u003e","\u003cspan class=pl-k\u003efrom\u003c/span\u003e \u003cspan class=pl-s1\u003efastapi_tdd\u003c/span\u003e.\u003cspan class=pl-s1\u003erouters\u003c/span\u003e \u003cspan class=pl-k\u003eimport\u003c/span\u003e \u003cspan class=pl-s1\u003eapi_router\u003c/span\u003e","","","\u003cspan class=pl-k\u003eclass\u003c/span\u003e \u003cspan class=pl-v\u003eApp\u003c/span\u003e(\u003cspan class=pl-v\u003eFastAPI\u003c/span\u003e):","    \u003cspan class=pl-k\u003edef\u003c/span\u003e \u003cspan class=pl-en\u003e__init__\u003c/span\u003e(\u003cspan class=pl-s1\u003eself\u003c/span\u003e, \u003cspan class=pl-c1\u003e*\u003c/span\u003e\u003cspan class=pl-s1\u003eargs\u003c/span\u003e, \u003cspan class=pl-c1\u003e**\u003c/span\u003e\u003cspan class=pl-s1\u003ekwargs\u003c/span\u003e) \u003cspan class=pl-c1\u003e-\u0026gt;\u003c/span\u003e \u003cspan class=pl-c1\u003eNone\u003c/span\u003e:","        \u003cspan class=pl-en\u003esuper\u003c/span\u003e().\u003cspan class=pl-en\u003e__init__\u003c/span\u003e(","            \u003cspan class=pl-c1\u003e*\u003c/span\u003e\u003cspan class=pl-s1\u003eargs\u003c/span\u003e,","            \u003cspan class=pl-c1\u003e**\u003c/span\u003e\u003cspan class=pl-s1\u003ekwargs\u003c/span\u003e,","            \u003cspan class=pl-s1\u003eversion\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026quot;0.1.0\u0026quot;\u003c/span\u003e,","            \u003cspan class=pl-s1\u003etitle\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s1\u003esettings\u003c/span\u003e.\u003cspan class=pl-v\u003ePROJECT_NAME\u003c/span\u003e,","            \u003cspan class=pl-s1\u003eroot_path\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s1\u003esettings\u003c/span\u003e.\u003cspan class=pl-v\u003eROOT_PATH\u003c/span\u003e","        )","","","\u003cspan class=pl-s1\u003eapp\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-v\u003eApp\u003c/span\u003e()","\u003cspan class=pl-s1\u003eapp\u003c/span\u003e.\u003cspan class=pl-en\u003einclude_router\u003c/span\u003e(\u003cspan class=pl-s1\u003eapi_router\u003c/span\u003e)"],"csv":null,"csvError":null,"dependabotInfo":{"showConfigurationBanner":false,"configFilePath":null,"networkDependabotPath":"/danielmarcosvilela/FastAPI_TDD/network/updates","dismissConfigurationNoticePath":"/settings/dismiss-notice/dependabot_configuration_notice","configurationNoticeDismissed":false},"displayName":"main.py","displayUrl":"https://github.com/danielmarcosvilela/FastAPI_TDD/blob/main/fastapi_tdd/main.py?raw=true","headerInfo":{"blobSize":"420 Bytes","deleteTooltip":"Fork this repository and delete the file","editTooltip":"Fork this repository and edit the file","ghDesktopPath":"https://desktop.github.com","isGitLfs":false,"onBranch":true,"shortPath":"92e4ba9","siteNavLoginPath":"/login?return_to=https%3A%2F%2Fgithub.com%2Fdanielmarcosvilela%2FFastAPI_TDD%2Fblob%2Fmain%2Ffastapi_tdd%2Fmain.py","isCSV":false,"isRichtext":false,"toc":null,"lineInfo":{"truncatedLoc":"18","truncatedSloc":"14"},"mode":"file"},"image":false,"isCodeownersFile":null,"isPlain":false,"isValidLegacyIssueTemplate":false,"issueTemplate":null,"discussionTemplate":null,"language":"Python","languageID":303,"large":false,"planSupportInfo":{"repoIsFork":null,"repoOwnedByCurrentUser":null,"requestFullPath":"/danielmarcosvilela/FastAPI_TDD/blob/main/fastapi_tdd/main.py","showFreeOrgGatedFeatureMessage":null,"showPlanSupportBanner":null,"upgradeDataAttributes":null,"upgradePath":null},"publishBannersInfo":{"dismissActionNoticePath":"/settings/dismiss-notice/publish_action_from_dockerfile","releasePath":"/danielmarcosvilela/FastAPI_TDD/releases/new?marketplace=true","showPublishActionBanner":false},"rawBlobUrl":"https://github.com/danielmarcosvilela/FastAPI_TDD/raw/main/fastapi_tdd/main.py","renderImageOrRaw":false,"richText":null,"renderedFileInfo":null,"shortPath":null,"symbolsEnabled":true,"tabSize":8,"topBannersInfo":{"overridingGlobalFundingFile":false,"globalPreferredFundingPath":null,"showInvalidCitationWarning":false,"citationHelpUrl":"https://docs.github.com/github/creating-cloning-and-archiving-repositories/creating-a-repository-on-github/about-citation-files","actionsOnboardingTip":null},"truncated":false,"viewable":true,"workflowRedirectUrl":null,"symbols":{"timed_out":false,"not_analyzed":false,"symbols":[{"name":"App","kind":"class","ident_start":124,"ident_end":127,"extent_start":118,"extent_end":374,"fully_qualified_name":"App","ident_utf16":{"start":{"line_number":5,"utf16_col":6},"end":{"line_number":5,"utf16_col":9}},"extent_utf16":{"start":{"line_number":5,"utf16_col":0},"end":{"line_number":13,"utf16_col":9}}},{"name":"__init__","kind":"function","ident_start":146,"ident_end":154,"extent_start":142,"extent_end":374,"fully_qualified_name":"App.__init__","ident_utf16":{"start":{"line_number":6,"utf16_col":8},"end":{"line_number":6,"utf16_col":16}},"extent_utf16":{"start":{"line_number":6,"utf16_col":4},"end":{"line_number":13,"utf16_col":9}}},{"name":"app","kind":"constant","ident_start":377,"ident_end":380,"extent_start":377,"extent_end":388,"fully_qualified_name":"app","ident_utf16":{"start":{"line_number":16,"utf16_col":0},"end":{"line_number":16,"utf16_col":3}},"extent_utf16":{"start":{"line_number":16,"utf16_col":0},"end":{"line_number":16,"utf16_col":11}}}]}},"copilotInfo":{"documentationUrl":"https://docs.github.com/copilot/overview-of-github-copilot/about-github-copilot-for-individuals","notices":{"codeViewPopover":{"dismissed":false,"dismissPath":"/settings/dismiss-notice/code_view_copilot_popover"}},"userAccess":{"hasSubscriptionEnded":false,"orgHasCFBAccess":false,"userHasCFIAccess":false,"userHasOrgs":false,"userIsOrgAdmin":false,"userIsOrgMember":false,"business":null,"featureRequestInfo":null}},"copilotAccessAllowed":false,"csrf_tokens":{"/danielmarcosvilela/FastAPI_TDD/branches":{"post":"RYX54vnZ6SOqzAdCa0WBUQA5KxhRdANzhTIHn1K8ewabDP7Hp6446VIsZTpIYhOEBLLbw2eFnptUDeLrGR1C2A"},"/repos/preferences":{"post":"e5Pa-uOcuNiezG0qDK0R7s43epUxMRtLe2hSU5U4mqFA3_yJAJGXIIUPjJsXQLeA9WSyWVTFUw9bMP5--flcwg"}}},"title":"FastAPI_TDD/fastapi_tdd/main.py at main · danielmarcosvilela/FastAPI_TDD","appPayload":{"helpUrl":"https://docs.github.com","findFileWorkerPath":"/assets-cdn/worker/find-file-worker-1583894afd38.js","findInFileWorkerPath":"/assets-cdn/worker/find-in-file-worker-3a63a487027b.js","githubDevUrl":"https://github.dev/","enabled_features":{"code_nav_ui_events":false,"react_blob_overlay":true,"copilot_conversational_ux_embedding_update":false,"copilot_smell_icebreaker_ux":true,"copilot_workspace":false}}}</script>
...
<div id="LC6" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-k>class</span> <span class=pl-v>App</span>(<span class=pl-v>FastAPI</span>):</div>
<div id="LC7" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-5 ">    <span class=pl-k>def</span> <span class=pl-en>__init__</span>(<span class=pl-s1>self</span>, <span class=pl-c1>*</span><span class=pl-s1>args</span>, <span class=pl-c1>**</span><span class=pl-s1>kwargs</span>) <span class=pl-c1>-&gt;</span> <span class=pl-c1>None</span>:</div>
<div id="LC8" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-5 child-of-line-6 ">        <span class=pl-en>super</span>().<span class=pl-en>__init__</span>(</div>
<div id="LC9" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-5 child-of-line-6 ">            <span class=pl-c1>*</span><span class=pl-s1>args</span>,</div>
<div id="LC10" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-5 child-of-line-6 ">            <span class=pl-c1>**</span><span class=pl-s1>kwargs</span>,</div>
<div id="LC11" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-5 child-of-line-6 ">            <span class=pl-s1>version</span><span class=pl-c1>=</span><span class=pl-s>&quot;0.1.0&quot;</span>,</div>
<div id="LC12" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-5 child-of-line-6 ">            <span class=pl-s1>title</span><span class=pl-c1>=</span><span class=pl-s1>settings</span>.<span class=pl-v>PROJECT_NAME</span>,</div>
<div id="LC13" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-5 child-of-line-6 ">            <span class=pl-s1>root_path</span><span class=pl-c1>=</span><span class=pl-s1>settings</span>.<span class=pl-v>ROOT_PATH</span></div>
