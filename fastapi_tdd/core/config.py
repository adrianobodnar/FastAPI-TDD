...
<link crossorigin="anonymous" media="all" rel="stylesheet" href="https://github.githubassets.com/assets/react-code-view.234ae39ff1fa1232236c.module.css" />
  ...
  <title>FastAPI_TDD/fastapi_tdd/core/config.py at main · danielmarcosvilela/FastAPI_TDD</title>
  ...
  <meta name="request-id" content="62E8:2F9AFB:4DD7F7:548F46:668DE1E8" data-turbo-transient="true" /><meta name="html-safe-nonce" content="f8867c2128ae1a2f1350c72a96d0127f74529d5a6c985793258613fe2360e2c0" data-turbo-transient="true" /><meta name="visitor-payload" content="" data-turbo-transient="true" /><meta name="visitor-hmac" content="e55f63659edf4cf2e1e942b8e52a959b0899b38bb93cfdc14d8a2a6d5d1c0d3c" data-turbo-transient="true" />
...
<meta name="octolytics-url" content="https://collector.github.com/github/collect" /><meta name="octolytics-actor-id" content="169305262" /><meta name="octolytics-actor-login" content="adrianobodnar" /><meta name="octolytics-actor-hash" content="da544cd792fa1452e5d2abecdf3ddf3954e802e6a8c16649340a1280512e432b" />
  ...
  <link rel="sudo-modal" href="/sessions/sudo_modal">
    ...
    <meta name="apple-itunes-app" content="app-id=1477376905, app-argument=https://github.com/danielmarcosvilela/FastAPI_TDD/blob/main/fastapi_tdd/core/config.py" />

      <meta name="twitter:image:src" content="https://opengraph.githubassets.com/2f3d655158b26cb2701a05ec38619a14ad7c312e034454b1619e168f7d34834d/danielmarcosvilela/FastAPI_TDD" /><meta name="twitter:site" content="@github" /><meta name="twitter:card" content="summary_large_image" /><meta name="twitter:title" content="FastAPI_TDD/fastapi_tdd/core/config.py at main · danielmarcosvilela/FastAPI_TDD" /><meta name="twitter:description" content="Criando Uma API Com FastAPI Utilizando TDD. Contribute to danielmarcosvilela/FastAPI_TDD development by creating an account on GitHub." />
  <meta property="og:image" content="https://opengraph.githubassets.com/2f3d655158b26cb2701a05ec38619a14ad7c312e034454b1619e168f7d34834d/danielmarcosvilela/FastAPI_TDD" /><meta property="og:image:alt" content="Criando Uma API Com FastAPI Utilizando TDD. Contribute to danielmarcosvilela/FastAPI_TDD development by creating an account on GitHub." /><meta property="og:image:width" content="1200" /><meta property="og:image:height" content="600" /><meta property="og:site_name" content="GitHub" /><meta property="og:type" content="object" /><meta property="og:title" content="FastAPI_TDD/fastapi_tdd/core/config.py at main · danielmarcosvilela/FastAPI_TDD" /><meta property="og:url" content="https://github.com/danielmarcosvilela/FastAPI_TDD/blob/main/fastapi_tdd/core/config.py" /><meta property="og:description" content="Criando Uma API Com FastAPI Utilizando TDD. Contribute to danielmarcosvilela/FastAPI_TDD development by creating an account on GitHub." />
  


      <link rel="shared-web-socket" href="wss://alive.github.com/_sockets/u/169305262/ws?session=eyJ2IjoiVjMiLCJ1IjoxNjkzMDUyNjIsInMiOjEzNzY0MTk4NDYsImMiOjI2MzMyNTc5NzgsInQiOjE3MjA1NzQ0NDZ9--ecb0774cb4c32d5d7004a18a6a3741b9fdd67ea910dec4dfeef32c432ad9f754" data-refresh-url="/_alive" data-session-id="342bf16456046948c5ebe94701ed19d497595272803f04c14b39f62bc6d40c1f">
...
>
  ...
  <include-fragment data-target="deferred-side-panel.fragment">
      <button aria-label="Open global navigation menu" data-action="click:deferred-side-panel#loadPanel click:deferred-side-panel#panelOpened" data-show-dialog-id="dialog-d440ae5a-40c5-4c06-ba76-62c5385d7f8f" id="dialog-show-dialog-d440ae5a-40c5-4c06-ba76-62c5385d7f8f" type="button" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button color-bg-transparent p-0 color-fg-muted">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-three-bars Button-visual">
    <path d="M1 2.75A.75.75 0 0 1 1.75 2h12.5a.75.75 0 0 1 0 1.5H1.75A.75.75 0 0 1 1 2.75Zm0 5A.75.75 0 0 1 1.75 7h12.5a.75.75 0 0 1 0 1.5H1.75A.75.75 0 0 1 1 7.75ZM1.75 12h12.5a.75.75 0 0 1 0 1.5H1.75a.75.75 0 0 1 0-1.5Z"></path>
</svg>
</button>

<dialog-helper>
  <dialog data-target="deferred-side-panel.panel" id="dialog-d440ae5a-40c5-4c06-ba76-62c5385d7f8f" aria-modal="true" aria-labelledby="dialog-d440ae5a-40c5-4c06-ba76-62c5385d7f8f-title" aria-describedby="dialog-d440ae5a-40c5-4c06-ba76-62c5385d7f8f-description" data-view-component="true" class="Overlay Overlay-whenNarrow Overlay--size-small-portrait Overlay--motion-scaleFade Overlay--placement-left SidePanel">
    <div styles="flex-direction: row;" data-view-component="true" class="Overlay-header">
  <div class="Overlay-headerContentWrap">
    <div class="Overlay-titleWrap">
      <h1 class="Overlay-title sr-only" id="dialog-d440ae5a-40c5-4c06-ba76-62c5385d7f8f-title">
        Global navigation
      </h1>
    ...
    <div class="Overlay-actionWrap">
      <button data-close-dialog-id="dialog-d440ae5a-40c5-4c06-ba76-62c5385d7f8f" aria-label="Close" type="button" data-view-component="true" class="close-button Overlay-closeButton"><svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="dialog-d440ae5a-40c5-4c06-ba76-62c5385d7f8f-title">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g d" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;HOME&quot;,&quot;label&quot;:null}" id="item-d749997d-0173-46a1-9b63-1f5ec4592d6c" href="/dashboard" data-view-component="true" class="ActionListContent ActionListContent--visual16">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g i" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;ISSUES&quot;,&quot;label&quot;:null}" id="item-b5bb61eb-ebc7-4bf4-9b15-9450aeeccb27" href="/issues" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g p" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PULL_REQUESTS&quot;,&quot;label&quot;:null}" id="item-3fb70f93-5d0e-4787-91ec-95a163fc9ac9" href="/pulls" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-item-id="projects" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PROJECTS&quot;,&quot;label&quot;:null}" id="item-4fef27c8-c81c-423d-b5ce-1ddb3982dc27" href="/projects" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;DISCUSSIONS&quot;,&quot;label&quot;:null}" id="item-94e0426c-8c7d-4c0c-af8d-ae104f60dd80" href="/discussions" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;CODESPACES&quot;,&quot;label&quot;:null}" id="item-8cd1137f-50f9-41a7-a3aa-6f3b8742da10" href="https://github.com/codespaces" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;EXPLORE&quot;,&quot;label&quot;:null}" id="item-af51916d-4fba-4f08-ae8b-b27b4156775d" href="/explore" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;MARKETPLACE&quot;,&quot;label&quot;:null}" id="item-b9e540ad-4d9d-4a2b-932b-320f18f82309" href="/marketplace" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<qbsearch-input class="search-input" data-scope="repo:danielmarcosvilela/FastAPI_TDD" data-custom-scopes-path="/search/custom_scopes" data-delete-custom-scopes-csrf="XDp7ZDrznMtwy17-UneYJNXzK0SViH5JrHM9Ae6CTRLU3RzKcNZ_aSeqcp0jkFdVYvHz1WFq8nDUkTqugZpWbQ" data-max-custom-scopes="10" data-header-redesign-enabled="true" data-initial-value="" data-blackbird-suggestions-path="/search/suggestions" data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations" data-current-repository="danielmarcosvilela/FastAPI_TDD" data-current-org="" data-current-owner="danielmarcosvilela" data-logged-in="true" data-copilot-chat-enabled="false" data-blackbird-indexed-repo-csrf="<input type=&quot;hidden&quot; value=&quot;i_XzGIUvcRUtFSF95h2eQU9eYtWOW0l4ks38Ki2orv_RoZ-mSC4q_3zPr-0xaWcPVmaygRHUMNpoGmDIQP3TLw&quot; data-csrf=&quot;true&quot; />" data-nl-search-enabled="false">
  <div
    ...
    <path d="M10.68 11.74a6 6 0 0 1-7.922-8.982 6 6 0 0 1 8.982 7.922l3.04 3.04a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215ZM11.5 7a4.499 4.499 0 1 0-8.997 0A4.499 4.499 0 0 0 11.5 7Z"></path>
        ...
        <div data-target="query-builder.styledInputContainer" class="QueryBuilder-StyledInputContainer">
          ...
          <div class="QueryBuilder-InputWrapper">
            ...
            <input id="query-builder-test" name="query-builder-test" value="" autocomplete="off" type="text" role="combobox" spellcheck="false" aria-expanded="false" aria-describedby="validation-ea816c54-d52e-49d4-ab6a-f535aaa89d1d" data-target="query-builder.input" data-action="
...
<template id="device-desktop-icon">
  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-device-desktop">
    <path d="M14.25 1c.966 0 1.75.784 1.75 1.75v7.5A1.75 1.75 0 0 1 14.25 12h-3.727c.099 1.041.52 1.872 1.292 2.757A.752.752 0 0 1 11.25 16h-6.5a.75.75 0 0 1-.565-1.243c.772-.885 1.192-1.716 1.292-2.757H1.75A1.75 1.75 0 0 1 0 10.25v-7.5C0 1.784.784 1 1.75 1ZM1.75 2.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25ZM9.018 12H6.982a5.72 5.72 0 0 1-.765 2.5h3.566a5.72 5.72 0 0 1-.765-2.5Z"></path>
      ...
      <div class="FormControl-inlineValidation" id="validation-ea816c54-d52e-49d4-ab6a-f535aaa89d1d" hidden="hidden">
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="feedback-dialog-title">
        <div data-view-component="true" class="Overlay-body">        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="code-search-feedback-form" data-turbo="false" action="/search/feedback" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="PK8sQ3QoQT9C7EhZu2XP7Xckf5d4xIx5RjK_Yex1-x6-DCf3JVDKKcLDsX9HFRljJ7q9sKntdjlFRdvHznDGDw" />
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="custom-scopes-dialog-title">
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="custom-scopes-dialog-form" data-turbo="false" action="/search/custom_scopes" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="c9l_1cHs4rn5s6CifE5tIJj2EPksoXFtowiFGK1z7hdB4G-blOpMmt59NrCVK9g_V3yDkhy3rshZHnbrzub5vQ" />
          ...
          <div class="form-group">
            ...
            <auto-check src="/search/custom_scopes/check_name" required>
              <input
                ...
                required
                maxlength="50">
              <input type="hidden" value="X_rMXfQEPTWFJavpnlKiY44Pa8Ql9iJsJz-KxrHuLaG80Dk56mPDANQi-XcXW3jrErJPLIkTHUPQfmwBzjWNXA" data-csrf="true" />
            </auto-check>
          </div>
...
</qbsearch-input><input type="hidden" value="GYNCpo-dGrfv2einkQ9fgEer4XEnOHJhgJce6c0RJ4HAamKQuDF5r7h31eJ4gb_e2n6CBnhpsQdME1rrf38vtg" data-csrf="true" class="js-data-jump-to-suggestions-path-csrf" />
...
</button><tool-tip id="tooltip-c32a8fac-9ca4-454d-a0c4-27c8cb7f8ac7" for="global-create-menu-anchor" popover="manual" data-direction="s" data-type="description" data-view-component="true" class="sr-only position-absolute">Create new...</tool-tip>
...
>
  ...
  <div data-target="react-partial.reactRoot"></div>
          ...
          <a href="/issues" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;ISSUES_HEADER&quot;,&quot;label&quot;:null}" id="icon-button-be65aeed-f154-432e-8d05-84139f2daedf" aria-labelledby="tooltip-a2163141-461a-4bba-8abb-cf05d655a452" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button color-fg-muted">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-issue-opened Button-visual">
    <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
</svg>
</a><tool-tip id="tooltip-a2163141-461a-4bba-8abb-cf05d655a452" for="icon-button-be65aeed-f154-432e-8d05-84139f2daedf" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Issues</tool-tip>

          <a href="/pulls" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PULL_REQUESTS_HEADER&quot;,&quot;label&quot;:null}" id="icon-button-1ca7c941-6029-4b6e-b3ab-e170b3541747" aria-labelledby="tooltip-09841bd7-93c6-4955-b508-3510fc7805c3" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button color-fg-muted">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-git-pull-request Button-visual">
    <path d="M1.5 3.25a2.25 2.25 0 1 1 3 2.122v5.256a2.251 2.251 0 1 1-1.5 0V5.372A2.25 2.25 0 0 1 1.5 3.25Zm5.677-.177L9.573.677A.25.25 0 0 1 10 .854V2.5h1A2.5 2.5 0 0 1 13.5 5v5.628a2.251 2.251 0 1 1-1.5 0V5a1 1 0 0 0-1-1h-1v1.646a.25.25 0 0 1-.427.177L7.177 3.427a.25.25 0 0 1 0-.354ZM3.75 2.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm0 9.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm8.25.75a.75.75 0 1 0 1.5 0 .75.75 0 0 0-1.5 0Z"></path>
</svg>
</a><tool-tip id="tooltip-09841bd7-93c6-4955-b508-3510fc7805c3" for="icon-button-1ca7c941-6029-4b6e-b3ab-e170b3541747" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Pull requests</tool-tip>

        </div>

        <notification-indicator data-channel="eyJjIjoibm90aWZpY2F0aW9uLWNoYW5nZWQ6MTY5MzA1MjYyIiwidCI6MTcyMDU3NDQ0Nn0=--ef7bd194625cc25faefbc6408c9e2b23c4b54670407f4e97bc9cc8e724739f55" data-indicator-mode="none" data-tooltip-global="You have unread notifications" data-tooltip-unavailable="Notifications are unavailable at the moment." data-tooltip-none="You have no unread notifications" data-header-redesign-enabled="true" data-fetch-indicator-src="/notifications/indicator" data-fetch-indicator-enabled="true" data-view-component="true" class="js-socket-channel">
...
<site-header-logged-in-user-menu>
  ...
  <focus-group direction="vertical" mnemonics retain>
    <button id="action-menu-f9d28db3-c15f-4d38-ba35-83dc91ffcbfc-button" popovertarget="action-menu-f9d28db3-c15f-4d38-ba35-83dc91ffcbfc-overlay" aria-controls="action-menu-f9d28db3-c15f-4d38-ba35-83dc91ffcbfc-list" aria-haspopup="true" aria-labelledby="tooltip-0d2c5e2c-c220-4c1e-b01f-fba2f68236c0" type="button" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium UnderlineNav-item">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-kebab-horizontal Button-visual">
    <path d="M8 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3ZM1.5 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm13 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path>
</svg>
</button><tool-tip id="tooltip-0d2c5e2c-c220-4c1e-b01f-fba2f68236c0" for="action-menu-f9d28db3-c15f-4d38-ba35-83dc91ffcbfc-button" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Additional navigation options</tool-tip>


<anchored-position id="action-menu-f9d28db3-c15f-4d38-ba35-83dc91ffcbfc-overlay" anchor="action-menu-f9d28db3-c15f-4d38-ba35-83dc91ffcbfc-button" align="start" side="outside-bottom" anchor-offset="normal" popover="auto" data-view-component="true">
  <div data-view-component="true" class="Overlay Overlay--size-auto">
    
      <div data-view-component="true" class="Overlay-body Overlay-body--paddingNone">          <action-list>
  <div data-view-component="true">
    <ul aria-labelledby="action-menu-f9d28db3-c15f-4d38-ba35-83dc91ffcbfc-button" id="action-menu-f9d28db3-c15f-4d38-ba35-83dc91ffcbfc-list" role="menu" data-view-component="true" class="ActionListWrap--inset ActionListWrap">
        <li hidden="hidden" data-menu-item="i0code-tab" data-targets="action-list.items" role="none" data-view-component="true" class="ActionListItem">
    
    
    <a tabindex="-1" id="item-b225a521-d8cc-452f-9ec1-d22572447b51" href="/danielmarcosvilela/FastAPI_TDD" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-code">
    <path d="m11.28 3.22 4.25 4.25a.75.75 0 0 1 0 1.06l-4.25 4.25a.749.749 0 0 1-1.275-.326.749.749 0 0 1 .215-.734L13.94 8l-3.72-3.72a.749.749 0 0 1 .326-1.275.749.749 0 0 1 .734.215Zm-6.56 0a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042L2.06 8l3.72 3.72a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L.47 8.53a.75.75 0 0 1 0-1.06Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-0db9964c-e3ed-4a2a-a337-85e4fbf8d37a" href="/danielmarcosvilela/FastAPI_TDD/issues" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-issue-opened">
    <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-5d78e299-bd3f-4af9-b5e7-bb7fcb6f8f6a" href="/danielmarcosvilela/FastAPI_TDD/pulls" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-git-pull-request">
    <path d="M1.5 3.25a2.25 2.25 0 1 1 3 2.122v5.256a2.251 2.251 0 1 1-1.5 0V5.372A2.25 2.25 0 0 1 1.5 3.25Zm5.677-.177L9.573.677A.25.25 0 0 1 10 .854V2.5h1A2.5 2.5 0 0 1 13.5 5v5.628a2.251 2.251 0 1 1-1.5 0V5a1 1 0 0 0-1-1h-1v1.646a.25.25 0 0 1-.427.177L7.177 3.427a.25.25 0 0 1 0-.354ZM3.75 2.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm0 9.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm8.25.75a.75.75 0 1 0 1.5 0 .75.75 0 0 0-1.5 0Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-83a3f669-93f3-4c39-a880-0d0df9056951" href="/danielmarcosvilela/FastAPI_TDD/actions" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-play">
    <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Zm4.879-2.773 4.264 2.559a.25.25 0 0 1 0 .428l-4.264 2.559A.25.25 0 0 1 6 10.559V5.442a.25.25 0 0 1 .379-.215Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-2c4e6585-8f9e-409b-8c1b-156ad64389a6" href="/danielmarcosvilela/FastAPI_TDD/projects" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-table">
    <path d="M0 1.75C0 .784.784 0 1.75 0h12.5C15.216 0 16 .784 16 1.75v12.5A1.75 1.75 0 0 1 14.25 16H1.75A1.75 1.75 0 0 1 0 14.25ZM6.5 6.5v8h7.75a.25.25 0 0 0 .25-.25V6.5Zm8-1.5V1.75a.25.25 0 0 0-.25-.25H6.5V5Zm-13 1.5v7.75c0 .138.112.25.25.25H5v-8ZM5 5V1.5H1.75a.25.25 0 0 0-.25.25V5Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-05f55c93-a83e-4acc-83da-8e339b192cd8" href="/danielmarcosvilela/FastAPI_TDD/security" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-35de2c01-1318-4196-9087-192ecebefd2c" href="/danielmarcosvilela/FastAPI_TDD/pulse" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <button id="icon-button-30d206fe-8403-480c-9edf-cbe3191352a1" aria-labelledby="tooltip-161be3bb-b6e1-4010-8bd4-84f8157eccb1" type="button" data-view-component="true" class="Button Button--iconOnly Button--invisible Button--medium flash-close js-flash-close">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x Button-visual">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
</svg>
</button><tool-tip id="tooltip-161be3bb-b6e1-4010-8bd4-84f8157eccb1" for="icon-button-30d206fe-8403-480c-9edf-cbe3191352a1" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Dismiss alert</tool-tip>
...
<div class="flash flash-full   {{ className }}">
  <div >
    ...
    <notification-shelf-watcher data-base-url="https://github.com/notifications/beta/shelf" data-channel="eyJjIjoibm90aWZpY2F0aW9uLWNoYW5nZWQ6MTY5MzA1MjYyIiwidCI6MTcyMDU3NDQ0Nn0=--ef7bd194625cc25faefbc6408c9e2b23c4b54670407f4e97bc9cc8e724739f55" data-view-component="true" class="js-socket-channel"></notification-shelf-watcher>
...
<react-app
  ...
  initial-path="/danielmarcosvilela/FastAPI_TDD/blob/main/fastapi_tdd/core/config.py"
...
>
  ...
  <script type="application/json" data-target="react-app.embeddedData">{"payload":{"allShortcutsEnabled":true,"fileTree":{"fastapi_tdd/core":{"items":[{"name":"__pycache__","path":"fastapi_tdd/core/__pycache__","contentType":"directory"},{"name":"__init__.py","path":"fastapi_tdd/core/__init__.py","contentType":"file"},{"name":"config.py","path":"fastapi_tdd/core/config.py","contentType":"file"},{"name":"exceptions.py","path":"fastapi_tdd/core/exceptions.py","contentType":"file"}],"totalCount":4},"fastapi_tdd":{"items":[{"name":"__pycache__","path":"fastapi_tdd/__pycache__","contentType":"directory"},{"name":"controllers","path":"fastapi_tdd/controllers","contentType":"directory"},{"name":"core","path":"fastapi_tdd/core","contentType":"directory"},{"name":"db","path":"fastapi_tdd/db","contentType":"directory"},{"name":"models","path":"fastapi_tdd/models","contentType":"directory"},{"name":"schemas","path":"fastapi_tdd/schemas","contentType":"directory"},{"name":"usecases","path":"fastapi_tdd/usecases","contentType":"directory"},{"name":"__init__.py","path":"fastapi_tdd/__init__.py","contentType":"file"},{"name":"main.py","path":"fastapi_tdd/main.py","contentType":"file"},{"name":"routers.py","path":"fastapi_tdd/routers.py","contentType":"file"}],"totalCount":10},"":{"items":[{"name":"fastapi_tdd","path":"fastapi_tdd","contentType":"directory"},{"name":"tests","path":"tests","contentType":"directory"},{"name":".env","path":".env","contentType":"file"},{"name":".pre-commit-config.yaml","path":".pre-commit-config.yaml","contentType":"file"},{"name":".python-version","path":".python-version","contentType":"file"},{"name":"Makefile","path":"Makefile","contentType":"file"},{"name":"README.md","path":"README.md","contentType":"file"},{"name":"docker-compose.yml","path":"docker-compose.yml","contentType":"file"},{"name":"poetry.lock","path":"poetry.lock","contentType":"file"},{"name":"pyproject.toml","path":"pyproject.toml","contentType":"file"}],"totalCount":10}},"fileTreeProcessingTime":6.325438,"foldersToFetch":[],"repo":{"id":793583549,"defaultBranch":"main","name":"FastAPI_TDD","ownerLogin":"danielmarcosvilela","currentUserCanPush":false,"isFork":false,"isEmpty":false,"createdAt":"2024-04-29T10:49:44.000-03:00","ownerAvatar":"https://avatars.githubusercontent.com/u/83494779?v=4","public":true,"private":false,"isOrgOwned":false},"codeLineWrapEnabled":false,"symbolsExpanded":true,"treeExpanded":true,"refInfo":{"name":"main","listCacheKey":"v0:1714484464.0","canEdit":true,"refType":"branch","currentOid":"aaebd12f7d696b078140cbf032144aea34ab2d40"},"path":"fastapi_tdd/core/config.py","currentUser":{"id":169305262,"login":"adrianobodnar","userEmail":"adrianobod@gmail.com"},"blob":{"rawLines":["from pydantic_settings import BaseSettings, SettingsConfigDict","","","class Settings(BaseSettings):","    PROJECT_NAME: str = \"Store API\"","    ROOT_PATH: str = \"/\"","","    DATABASE_URL: str","","    model_config = SettingsConfigDict(env_file=\".env\")","","","settings = Settings()"],"stylingDirectives":null,"colorizedLines":["\u003cspan class=pl-k\u003efrom\u003c/span\u003e \u003cspan class=pl-s1\u003epydantic_settings\u003c/span\u003e \u003cspan class=pl-k\u003eimport\u003c/span\u003e \u003cspan class=pl-v\u003eBaseSettings\u003c/span\u003e, \u003cspan class=pl-v\u003eSettingsConfigDict\u003c/span\u003e","","","\u003cspan class=pl-k\u003eclass\u003c/span\u003e \u003cspan class=pl-v\u003eSettings\u003c/span\u003e(\u003cspan class=pl-v\u003eBaseSettings\u003c/span\u003e):","    \u003cspan class=pl-v\u003ePROJECT_NAME\u003c/span\u003e: \u003cspan class=pl-s1\u003estr\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-s\u003e\u0026quot;Store API\u0026quot;\u003c/span\u003e","    \u003cspan class=pl-v\u003eROOT_PATH\u003c/span\u003e: \u003cspan class=pl-s1\u003estr\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-s\u003e\u0026quot;/\u0026quot;\u003c/span\u003e","","    \u003cspan class=pl-v\u003eDATABASE_URL\u003c/span\u003e: \u003cspan class=pl-s1\u003estr\u003c/span\u003e","","    \u003cspan class=pl-s1\u003emodel_config\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-v\u003eSettingsConfigDict\u003c/span\u003e(\u003cspan class=pl-s1\u003eenv_file\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026quot;.env\u0026quot;\u003c/span\u003e)","","","\u003cspan class=pl-s1\u003esettings\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-v\u003eSettings\u003c/span\u003e()"],"csv":null,"csvError":null,"dependabotInfo":{"showConfigurationBanner":false,"configFilePath":null,"networkDependabotPath":"/danielmarcosvilela/FastAPI_TDD/network/updates","dismissConfigurationNoticePath":"/settings/dismiss-notice/dependabot_configuration_notice","configurationNoticeDismissed":false},"displayName":"config.py","displayUrl":"https://github.com/danielmarcosvilela/FastAPI_TDD/blob/main/fastapi_tdd/core/config.py?raw=true","headerInfo":{"blobSize":"259 Bytes","deleteTooltip":"Fork this repository and delete the file","editTooltip":"Fork this repository and edit the file","ghDesktopPath":"https://desktop.github.com","isGitLfs":false,"onBranch":true,"shortPath":"c812740","siteNavLoginPath":"/login?return_to=https%3A%2F%2Fgithub.com%2Fdanielmarcosvilela%2FFastAPI_TDD%2Fblob%2Fmain%2Ffastapi_tdd%2Fcore%2Fconfig.py","isCSV":false,"isRichtext":false,"toc":null,"lineInfo":{"truncatedLoc":"13","truncatedSloc":"7"},"mode":"file"},"image":false,"isCodeownersFile":null,"isPlain":false,"isValidLegacyIssueTemplate":false,"issueTemplate":null,"discussionTemplate":null,"language":"Python","languageID":303,"large":false,"planSupportInfo":{"repoIsFork":null,"repoOwnedByCurrentUser":null,"requestFullPath":"/danielmarcosvilela/FastAPI_TDD/blob/main/fastapi_tdd/core/config.py","showFreeOrgGatedFeatureMessage":null,"showPlanSupportBanner":null,"upgradeDataAttributes":null,"upgradePath":null},"publishBannersInfo":{"dismissActionNoticePath":"/settings/dismiss-notice/publish_action_from_dockerfile","releasePath":"/danielmarcosvilela/FastAPI_TDD/releases/new?marketplace=true","showPublishActionBanner":false},"rawBlobUrl":"https://github.com/danielmarcosvilela/FastAPI_TDD/raw/main/fastapi_tdd/core/config.py","renderImageOrRaw":false,"richText":null,"renderedFileInfo":null,"shortPath":null,"symbolsEnabled":true,"tabSize":8,"topBannersInfo":{"overridingGlobalFundingFile":false,"globalPreferredFundingPath":null,"showInvalidCitationWarning":false,"citationHelpUrl":"https://docs.github.com/github/creating-cloning-and-archiving-repositories/creating-a-repository-on-github/about-citation-files","actionsOnboardingTip":null},"truncated":false,"viewable":true,"workflowRedirectUrl":null,"symbols":{"timed_out":false,"not_analyzed":false,"symbols":[{"name":"Settings","kind":"class","ident_start":71,"ident_end":79,"extent_start":65,"extent_end":234,"fully_qualified_name":"Settings","ident_utf16":{"start":{"line_number":3,"utf16_col":6},"end":{"line_number":3,"utf16_col":14}},"extent_utf16":{"start":{"line_number":3,"utf16_col":0},"end":{"line_number":9,"utf16_col":54}}},{"name":"PROJECT_NAME","kind":"constant","ident_start":99,"ident_end":111,"extent_start":99,"extent_end":130,"fully_qualified_name":"Settings.PROJECT_NAME","ident_utf16":{"start":{"line_number":4,"utf16_col":4},"end":{"line_number":4,"utf16_col":16}},"extent_utf16":{"start":{"line_number":4,"utf16_col":4},"end":{"line_number":4,"utf16_col":35}}},{"name":"ROOT_PATH","kind":"constant","ident_start":135,"ident_end":144,"extent_start":135,"extent_end":155,"fully_qualified_name":"Settings.ROOT_PATH","ident_utf16":{"start":{"line_number":5,"utf16_col":4},"end":{"line_number":5,"utf16_col":13}},"extent_utf16":{"start":{"line_number":5,"utf16_col":4},"end":{"line_number":5,"utf16_col":24}}},{"name":"DATABASE_URL","kind":"constant","ident_start":161,"ident_end":173,"extent_start":161,"extent_end":178,"fully_qualified_name":"Settings.DATABASE_URL","ident_utf16":{"start":{"line_number":7,"utf16_col":4},"end":{"line_number":7,"utf16_col":16}},"extent_utf16":{"start":{"line_number":7,"utf16_col":4},"end":{"line_number":7,"utf16_col":21}}},{"name":"model_config","kind":"constant","ident_start":184,"ident_end":196,"extent_start":184,"extent_end":234,"fully_qualified_name":"Settings.model_config","ident_utf16":{"start":{"line_number":9,"utf16_col":4},"end":{"line_number":9,"utf16_col":16}},"extent_utf16":{"start":{"line_number":9,"utf16_col":4},"end":{"line_number":9,"utf16_col":54}}},{"name":"settings","kind":"constant","ident_start":237,"ident_end":245,"extent_start":237,"extent_end":258,"fully_qualified_name":"settings","ident_utf16":{"start":{"line_number":12,"utf16_col":0},"end":{"line_number":12,"utf16_col":8}},"extent_utf16":{"start":{"line_number":12,"utf16_col":0},"end":{"line_number":12,"utf16_col":21}}}]}},"copilotInfo":{"documentationUrl":"https://docs.github.com/copilot/overview-of-github-copilot/about-github-copilot-for-individuals","notices":{"codeViewPopover":{"dismissed":false,"dismissPath":"/settings/dismiss-notice/code_view_copilot_popover"}},"userAccess":{"hasSubscriptionEnded":false,"orgHasCFBAccess":false,"userHasCFIAccess":false,"userHasOrgs":false,"userIsOrgAdmin":false,"userIsOrgMember":false,"business":null,"featureRequestInfo":null}},"copilotAccessAllowed":false,"csrf_tokens":{"/danielmarcosvilela/FastAPI_TDD/branches":{"post":"4SR11sqizD_2GVDIIfipCvXxFQHxxhQ-wj8XMpm50s4_rXLzlNUd9Q75MrAC3zvf8Xrl2sc3idYTAPJG0hjrEA"},"/repos/preferences":{"post":"t3UGkzCX0ufI2Yo5IN1Ub47EgejouoTIw708eWaoO1eMOSDg05r9H9Maa4g7MPIBtZdJJI1OzIzj5ZBUCmn9NA"}}},"title":"FastAPI_TDD/fastapi_tdd/core/config.py at main · danielmarcosvilela/FastAPI_TDD","appPayload":{"helpUrl":"https://docs.github.com","findFileWorkerPath":"/assets-cdn/worker/find-file-worker-1583894afd38.js","findInFileWorkerPath":"/assets-cdn/worker/find-in-file-worker-3a63a487027b.js","githubDevUrl":"https://github.dev/","enabled_features":{"code_nav_ui_events":false,"react_blob_overlay":true,"copilot_conversational_ux_embedding_update":false,"copilot_smell_icebreaker_ux":true,"copilot_workspace":false}}}</script>
...
<div id="LC4" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-k>class</span> <span class=pl-v>Settings</span>(<span class=pl-v>BaseSettings</span>):</div>
<div id="LC5" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-3 ">    <span class=pl-v>PROJECT_NAME</span>: <span class=pl-s1>str</span> <span class=pl-c1>=</span> <span class=pl-s>&quot;Store API&quot;</span></div>
<div id="LC6" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-3 ">    <span class=pl-v>ROOT_PATH</span>: <span class=pl-s1>str</span> <span class=pl-c1>=</span> <span class=pl-s>&quot;/&quot;</span></div>
<div id="LC7" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-3 ">
</div>
<div id="LC8" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-3 ">    <span class=pl-v>DATABASE_URL</span>: <span class=pl-s1>str</span></div>
<div id="LC9" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-3 ">
</div>
<div id="LC10" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">    <span class=pl-s1>model_config</span> <span class=pl-c1>=</span> <span class=pl-v>SettingsConfigDict</span>(<span class=pl-s1>env_file</span><span class=pl-c1>=</span><span class=pl-s>&quot;.env&quot;</span>)</div>
