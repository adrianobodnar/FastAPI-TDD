...
<link crossorigin="anonymous" media="all" rel="stylesheet" href="https://github.githubassets.com/assets/react-code-view.234ae39ff1fa1232236c.module.css" />
  ...
  <title>FastAPI_TDD/tests/conftest.py at main · danielmarcosvilela/FastAPI_TDD</title>
  ...
  <meta name="request-id" content="62E8:2F9AFB:4D5590:53FD20:668DE0C9" data-turbo-transient="true" /><meta name="html-safe-nonce" content="f8867c2128ae1a2f1350c72a96d0127f74529d5a6c985793258613fe2360e2c0" data-turbo-transient="true" /><meta name="visitor-payload" content="" data-turbo-transient="true" /><meta name="visitor-hmac" content="45e1bc4bc634b2cc8c77217086ca13590047044f3fce49e8a00e76909a78078d" data-turbo-transient="true" />
...
<meta name="octolytics-url" content="https://collector.github.com/github/collect" /><meta name="octolytics-actor-id" content="169305262" /><meta name="octolytics-actor-login" content="adrianobodnar" /><meta name="octolytics-actor-hash" content="da544cd792fa1452e5d2abecdf3ddf3954e802e6a8c16649340a1280512e432b" />
  ...
  <link rel="sudo-modal" href="/sessions/sudo_modal">
    ...
    <meta name="apple-itunes-app" content="app-id=1477376905, app-argument=https://github.com/danielmarcosvilela/FastAPI_TDD/blob/main/tests/conftest.py" />

      <meta name="twitter:image:src" content="https://opengraph.githubassets.com/2f3d655158b26cb2701a05ec38619a14ad7c312e034454b1619e168f7d34834d/danielmarcosvilela/FastAPI_TDD" /><meta name="twitter:site" content="@github" /><meta name="twitter:card" content="summary_large_image" /><meta name="twitter:title" content="FastAPI_TDD/tests/conftest.py at main · danielmarcosvilela/FastAPI_TDD" /><meta name="twitter:description" content="Criando Uma API Com FastAPI Utilizando TDD. Contribute to danielmarcosvilela/FastAPI_TDD development by creating an account on GitHub." />
  <meta property="og:image" content="https://opengraph.githubassets.com/2f3d655158b26cb2701a05ec38619a14ad7c312e034454b1619e168f7d34834d/danielmarcosvilela/FastAPI_TDD" /><meta property="og:image:alt" content="Criando Uma API Com FastAPI Utilizando TDD. Contribute to danielmarcosvilela/FastAPI_TDD development by creating an account on GitHub." /><meta property="og:image:width" content="1200" /><meta property="og:image:height" content="600" /><meta property="og:site_name" content="GitHub" /><meta property="og:type" content="object" /><meta property="og:title" content="FastAPI_TDD/tests/conftest.py at main · danielmarcosvilela/FastAPI_TDD" /><meta property="og:url" content="https://github.com/danielmarcosvilela/FastAPI_TDD/blob/main/tests/conftest.py" /><meta property="og:description" content="Criando Uma API Com FastAPI Utilizando TDD. Contribute to danielmarcosvilela/FastAPI_TDD development by creating an account on GitHub." />
  


      <link rel="shared-web-socket" href="wss://alive.github.com/_sockets/u/169305262/ws?session=eyJ2IjoiVjMiLCJ1IjoxNjkzMDUyNjIsInMiOjEzNzY0MTk4NDYsImMiOjIzNDc4NTU3ODUsInQiOjE3MjA1NzQxNTh9--621fa3583dc17621483f15db42756852b2c8cb7de2104ca4146e51dd6751c9c2" data-refresh-url="/_alive" data-session-id="342bf16456046948c5ebe94701ed19d497595272803f04c14b39f62bc6d40c1f">
...
>
  ...
  <include-fragment data-target="deferred-side-panel.fragment">
      <button aria-label="Open global navigation menu" data-action="click:deferred-side-panel#loadPanel click:deferred-side-panel#panelOpened" data-show-dialog-id="dialog-ec08e555-ae1a-4457-abc2-8d5d5a2aa15c" id="dialog-show-dialog-ec08e555-ae1a-4457-abc2-8d5d5a2aa15c" type="button" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button color-bg-transparent p-0 color-fg-muted">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-three-bars Button-visual">
    <path d="M1 2.75A.75.75 0 0 1 1.75 2h12.5a.75.75 0 0 1 0 1.5H1.75A.75.75 0 0 1 1 2.75Zm0 5A.75.75 0 0 1 1.75 7h12.5a.75.75 0 0 1 0 1.5H1.75A.75.75 0 0 1 1 7.75ZM1.75 12h12.5a.75.75 0 0 1 0 1.5H1.75a.75.75 0 0 1 0-1.5Z"></path>
</svg>
</button>

<dialog-helper>
  <dialog data-target="deferred-side-panel.panel" id="dialog-ec08e555-ae1a-4457-abc2-8d5d5a2aa15c" aria-modal="true" aria-labelledby="dialog-ec08e555-ae1a-4457-abc2-8d5d5a2aa15c-title" aria-describedby="dialog-ec08e555-ae1a-4457-abc2-8d5d5a2aa15c-description" data-view-component="true" class="Overlay Overlay-whenNarrow Overlay--size-small-portrait Overlay--motion-scaleFade Overlay--placement-left SidePanel">
    <div styles="flex-direction: row;" data-view-component="true" class="Overlay-header">
  <div class="Overlay-headerContentWrap">
    <div class="Overlay-titleWrap">
      <h1 class="Overlay-title sr-only" id="dialog-ec08e555-ae1a-4457-abc2-8d5d5a2aa15c-title">
        Global navigation
      </h1>
    ...
    <div class="Overlay-actionWrap">
      <button data-close-dialog-id="dialog-ec08e555-ae1a-4457-abc2-8d5d5a2aa15c" aria-label="Close" type="button" data-view-component="true" class="close-button Overlay-closeButton"><svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="dialog-ec08e555-ae1a-4457-abc2-8d5d5a2aa15c-title">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g d" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;HOME&quot;,&quot;label&quot;:null}" id="item-f4238fd0-b8c3-4398-a066-367893804921" href="/dashboard" data-view-component="true" class="ActionListContent ActionListContent--visual16">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g i" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;ISSUES&quot;,&quot;label&quot;:null}" id="item-685a241f-5be0-4dcb-a4cc-3f0e1ed00595" href="/issues" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g p" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PULL_REQUESTS&quot;,&quot;label&quot;:null}" id="item-4da22fc8-dbc3-4f25-99bf-856c0b2f4b26" href="/pulls" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-item-id="projects" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PROJECTS&quot;,&quot;label&quot;:null}" id="item-88f3d319-9f38-4ecc-aa9d-e10049bc4b46" href="/projects" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;DISCUSSIONS&quot;,&quot;label&quot;:null}" id="item-3061b26d-2573-4af4-94ba-c0e0b370a048" href="/discussions" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;CODESPACES&quot;,&quot;label&quot;:null}" id="item-74454ac6-8192-47a1-9f72-19b5fa0467c7" href="https://github.com/codespaces" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;EXPLORE&quot;,&quot;label&quot;:null}" id="item-e13bc71e-d404-478e-b7cf-4eec7247dfec" href="/explore" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;MARKETPLACE&quot;,&quot;label&quot;:null}" id="item-5f560264-1f01-4400-973f-6cb60e2a8097" href="/marketplace" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<qbsearch-input class="search-input" data-scope="repo:danielmarcosvilela/FastAPI_TDD" data-custom-scopes-path="/search/custom_scopes" data-delete-custom-scopes-csrf="4fbrNRqP1Q5_ooAhdMQyNdorBy8kXyuTc7Vzb_ktRR1pEYybUKo2rCjDrEIFI_1EbSnfvtC9p6oLV3TAljVeYg" data-max-custom-scopes="10" data-header-redesign-enabled="true" data-initial-value="" data-blackbird-suggestions-path="/search/suggestions" data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations" data-current-repository="danielmarcosvilela/FastAPI_TDD" data-current-org="" data-current-owner="danielmarcosvilela" data-logged-in="true" data-copilot-chat-enabled="false" data-blackbird-indexed-repo-csrf="<input type=&quot;hidden&quot; value=&quot;nBzHZqU9iTn_A-GziQUiVKS6wBlxHLVoU0qGUi--rIvGSKvYaDzS067ZbyNecdsavYIQTe6TzMqpnRqwQuvRWw&quot; data-csrf=&quot;true&quot; />" data-nl-search-enabled="false">
  <div
    ...
    <path d="M10.68 11.74a6 6 0 0 1-7.922-8.982 6 6 0 0 1 8.982 7.922l3.04 3.04a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215ZM11.5 7a4.499 4.499 0 1 0-8.997 0A4.499 4.499 0 0 0 11.5 7Z"></path>
        ...
        <div data-target="query-builder.styledInputContainer" class="QueryBuilder-StyledInputContainer">
          ...
          <div class="QueryBuilder-InputWrapper">
            ...
            <input id="query-builder-test" name="query-builder-test" value="" autocomplete="off" type="text" role="combobox" spellcheck="false" aria-expanded="false" aria-describedby="validation-f1abdde2-b1b4-4084-b1d8-83d14c74343d" data-target="query-builder.input" data-action="
...
<template id="device-desktop-icon">
  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-device-desktop">
    <path d="M14.25 1c.966 0 1.75.784 1.75 1.75v7.5A1.75 1.75 0 0 1 14.25 12h-3.727c.099 1.041.52 1.872 1.292 2.757A.752.752 0 0 1 11.25 16h-6.5a.75.75 0 0 1-.565-1.243c.772-.885 1.192-1.716 1.292-2.757H1.75A1.75 1.75 0 0 1 0 10.25v-7.5C0 1.784.784 1 1.75 1ZM1.75 2.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25ZM9.018 12H6.982a5.72 5.72 0 0 1-.765 2.5h3.566a5.72 5.72 0 0 1-.765-2.5Z"></path>
      ...
      <div class="FormControl-inlineValidation" id="validation-f1abdde2-b1b4-4084-b1d8-83d14c74343d" hidden="hidden">
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="feedback-dialog-title">
        <div data-view-component="true" class="Overlay-body">        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="code-search-feedback-form" data-turbo="false" action="/search/feedback" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="eXwydfdGb64EwiQ8_B1evcFcEUtO95dytFFuMX8bOJD73znBpj7kuITt3RoAbYgzkcLTbJ_ebTK3JgqXXR4FgQ" />
  ...
  <div class="Overlay-headerContentWrap">
    ...
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="custom-scopes-dialog-title">
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form id="custom-scopes-dialog-form" data-turbo="false" action="/search/custom_scopes" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="wdbrzgmrwZciUgV4vGegqGo86AF979FROojT-d3DIIrz7_uAXK1vtAWck2pVAhW3pbZ7ak35DvTAniAKvlY3IA" />
          ...
          <div class="form-group">
            ...
            <auto-check src="/search/custom_scopes/check_name" required>
              <input
                ...
                required
                maxlength="50">
              <input type="hidden" value="cWvbSNmfaveRvU_QsevGRhg0CrS4lq-A5jbLIZT5PImSQS4sx_iUwsC6HU444hzOhIkuXBRzkK8Rdy3m6yKcdA" data-csrf="true" />
            </auto-check>
          </div>
...
</qbsearch-input><input type="hidden" value="34ND7oZPT2nzYT9UE007Tq_Eg_hIjRw5OWgjnmhayJcGamPYseMscaTPAhH6w9sQMhHgjxfc31_17Gec2jTAoA" data-csrf="true" class="js-data-jump-to-suggestions-path-csrf" />
...
</button><tool-tip id="tooltip-838f98de-2b34-4862-a6b2-0cf7d5324f61" for="global-create-menu-anchor" popover="manual" data-direction="s" data-type="description" data-view-component="true" class="sr-only position-absolute">Create new...</tool-tip>
...
>
  ...
  <div data-target="react-partial.reactRoot"></div>
          ...
          <a href="/issues" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;ISSUES_HEADER&quot;,&quot;label&quot;:null}" id="icon-button-f5d525f6-3d24-4e51-949f-6917b6bfe3cb" aria-labelledby="tooltip-02d8af38-8b8b-4827-a049-84dd0d3a4f2c" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button color-fg-muted">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-issue-opened Button-visual">
    <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
</svg>
</a><tool-tip id="tooltip-02d8af38-8b8b-4827-a049-84dd0d3a4f2c" for="icon-button-f5d525f6-3d24-4e51-949f-6917b6bfe3cb" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Issues</tool-tip>

          <a href="/pulls" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PULL_REQUESTS_HEADER&quot;,&quot;label&quot;:null}" id="icon-button-9d523bac-1b7c-403c-bb2b-2ef4401bd4ca" aria-labelledby="tooltip-c75dd804-58f7-4b42-9ce4-a4f6b82c8741" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button color-fg-muted">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-git-pull-request Button-visual">
    <path d="M1.5 3.25a2.25 2.25 0 1 1 3 2.122v5.256a2.251 2.251 0 1 1-1.5 0V5.372A2.25 2.25 0 0 1 1.5 3.25Zm5.677-.177L9.573.677A.25.25 0 0 1 10 .854V2.5h1A2.5 2.5 0 0 1 13.5 5v5.628a2.251 2.251 0 1 1-1.5 0V5a1 1 0 0 0-1-1h-1v1.646a.25.25 0 0 1-.427.177L7.177 3.427a.25.25 0 0 1 0-.354ZM3.75 2.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm0 9.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm8.25.75a.75.75 0 1 0 1.5 0 .75.75 0 0 0-1.5 0Z"></path>
</svg>
</a><tool-tip id="tooltip-c75dd804-58f7-4b42-9ce4-a4f6b82c8741" for="icon-button-9d523bac-1b7c-403c-bb2b-2ef4401bd4ca" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Pull requests</tool-tip>

        </div>

        <notification-indicator data-channel="eyJjIjoibm90aWZpY2F0aW9uLWNoYW5nZWQ6MTY5MzA1MjYyIiwidCI6MTcyMDU3NDE1OH0=--b9837da172f9370b6f794b352d5450e0173d7b30c09dc170394a4bff228bb163" data-indicator-mode="none" data-tooltip-global="You have unread notifications" data-tooltip-unavailable="Notifications are unavailable at the moment." data-tooltip-none="You have no unread notifications" data-header-redesign-enabled="true" data-fetch-indicator-src="/notifications/indicator" data-fetch-indicator-enabled="true" data-view-component="true" class="js-socket-channel">
...
<site-header-logged-in-user-menu>
  ...
  <focus-group direction="vertical" mnemonics retain>
    <button id="action-menu-d58bdefe-bdfa-4b51-ae0c-5615e5c8deeb-button" popovertarget="action-menu-d58bdefe-bdfa-4b51-ae0c-5615e5c8deeb-overlay" aria-controls="action-menu-d58bdefe-bdfa-4b51-ae0c-5615e5c8deeb-list" aria-haspopup="true" aria-labelledby="tooltip-4fc7ab8e-89d3-469e-8e8b-1d807395592f" type="button" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium UnderlineNav-item">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-kebab-horizontal Button-visual">
    <path d="M8 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3ZM1.5 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm13 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path>
</svg>
</button><tool-tip id="tooltip-4fc7ab8e-89d3-469e-8e8b-1d807395592f" for="action-menu-d58bdefe-bdfa-4b51-ae0c-5615e5c8deeb-button" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Additional navigation options</tool-tip>


<anchored-position id="action-menu-d58bdefe-bdfa-4b51-ae0c-5615e5c8deeb-overlay" anchor="action-menu-d58bdefe-bdfa-4b51-ae0c-5615e5c8deeb-button" align="start" side="outside-bottom" anchor-offset="normal" popover="auto" data-view-component="true">
  <div data-view-component="true" class="Overlay Overlay--size-auto">
    
      <div data-view-component="true" class="Overlay-body Overlay-body--paddingNone">          <action-list>
  <div data-view-component="true">
    <ul aria-labelledby="action-menu-d58bdefe-bdfa-4b51-ae0c-5615e5c8deeb-button" id="action-menu-d58bdefe-bdfa-4b51-ae0c-5615e5c8deeb-list" role="menu" data-view-component="true" class="ActionListWrap--inset ActionListWrap">
        <li hidden="hidden" data-menu-item="i0code-tab" data-targets="action-list.items" role="none" data-view-component="true" class="ActionListItem">
    
    
    <a tabindex="-1" id="item-4a488766-a674-445a-b8f9-80bec62cc10c" href="/danielmarcosvilela/FastAPI_TDD" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-code">
    <path d="m11.28 3.22 4.25 4.25a.75.75 0 0 1 0 1.06l-4.25 4.25a.749.749 0 0 1-1.275-.326.749.749 0 0 1 .215-.734L13.94 8l-3.72-3.72a.749.749 0 0 1 .326-1.275.749.749 0 0 1 .734.215Zm-6.56 0a.751.751 0 0 1 1.042.018.751.751 0 0 1 .018 1.042L2.06 8l3.72 3.72a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L.47 8.53a.75.75 0 0 1 0-1.06Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-77a33a61-55b1-48ac-8c0a-9df40cdb2a7c" href="/danielmarcosvilela/FastAPI_TDD/issues" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-issue-opened">
    <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"></path><path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-1926236f-126c-473d-9eed-ee10225526f2" href="/danielmarcosvilela/FastAPI_TDD/pulls" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-git-pull-request">
    <path d="M1.5 3.25a2.25 2.25 0 1 1 3 2.122v5.256a2.251 2.251 0 1 1-1.5 0V5.372A2.25 2.25 0 0 1 1.5 3.25Zm5.677-.177L9.573.677A.25.25 0 0 1 10 .854V2.5h1A2.5 2.5 0 0 1 13.5 5v5.628a2.251 2.251 0 1 1-1.5 0V5a1 1 0 0 0-1-1h-1v1.646a.25.25 0 0 1-.427.177L7.177 3.427a.25.25 0 0 1 0-.354ZM3.75 2.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm0 9.5a.75.75 0 1 0 0 1.5.75.75 0 0 0 0-1.5Zm8.25.75a.75.75 0 1 0 1.5 0 .75.75 0 0 0-1.5 0Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-409de034-74c8-4a1b-831e-f6a9f6e65a54" href="/danielmarcosvilela/FastAPI_TDD/actions" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-play">
    <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0ZM1.5 8a6.5 6.5 0 1 0 13 0 6.5 6.5 0 0 0-13 0Zm4.879-2.773 4.264 2.559a.25.25 0 0 1 0 .428l-4.264 2.559A.25.25 0 0 1 6 10.559V5.442a.25.25 0 0 1 .379-.215Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-ab3d9093-b5bc-437c-a067-f0783dfd34b9" href="/danielmarcosvilela/FastAPI_TDD/projects" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
          <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-table">
    <path d="M0 1.75C0 .784.784 0 1.75 0h12.5C15.216 0 16 .784 16 1.75v12.5A1.75 1.75 0 0 1 14.25 16H1.75A1.75 1.75 0 0 1 0 14.25ZM6.5 6.5v8h7.75a.25.25 0 0 0 .25-.25V6.5Zm8-1.5V1.75a.25.25 0 0 0-.25-.25H6.5V5Zm-13 1.5v7.75c0 .138.112.25.25.25H5v-8ZM5 5V1.5H1.75a.25.25 0 0 0-.25.25V5Z"></path>
</svg>
    ...
    <a tabindex="-1" id="item-8f940586-7751-45d8-a427-db1ea3bda970" href="/danielmarcosvilela/FastAPI_TDD/security" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <a tabindex="-1" id="item-03fc5d17-a811-4363-bb07-8b70996c74a1" href="/danielmarcosvilela/FastAPI_TDD/pulse" role="menuitem" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <button id="icon-button-cd04789a-3163-42e1-a815-a90c52b497cf" aria-labelledby="tooltip-cf39524a-e36f-4346-ba93-965eff49107e" type="button" data-view-component="true" class="Button Button--iconOnly Button--invisible Button--medium flash-close js-flash-close">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x Button-visual">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
</svg>
</button><tool-tip id="tooltip-cf39524a-e36f-4346-ba93-965eff49107e" for="icon-button-cd04789a-3163-42e1-a815-a90c52b497cf" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Dismiss alert</tool-tip>
...
<div class="flash flash-full   {{ className }}">
  <div >
    ...
    <notification-shelf-watcher data-base-url="https://github.com/notifications/beta/shelf" data-channel="eyJjIjoibm90aWZpY2F0aW9uLWNoYW5nZWQ6MTY5MzA1MjYyIiwidCI6MTcyMDU3NDE1OH0=--b9837da172f9370b6f794b352d5450e0173d7b30c09dc170394a4bff228bb163" data-view-component="true" class="js-socket-channel"></notification-shelf-watcher>
...
<react-app
  ...
  initial-path="/danielmarcosvilela/FastAPI_TDD/blob/main/tests/conftest.py"
...
>
  ...
  <script type="application/json" data-target="react-app.embeddedData">{"payload":{"allShortcutsEnabled":true,"fileTree":{"tests":{"items":[{"name":"controllers","path":"tests/controllers","contentType":"directory"},{"name":"schemas","path":"tests/schemas","contentType":"directory"},{"name":"usecases","path":"tests/usecases","contentType":"directory"},{"name":"__init__.py","path":"tests/__init__.py","contentType":"file"},{"name":"conftest.py","path":"tests/conftest.py","contentType":"file"},{"name":"factories.py","path":"tests/factories.py","contentType":"file"}],"totalCount":6},"":{"items":[{"name":"fastapi_tdd","path":"fastapi_tdd","contentType":"directory"},{"name":"tests","path":"tests","contentType":"directory"},{"name":".env","path":".env","contentType":"file"},{"name":".pre-commit-config.yaml","path":".pre-commit-config.yaml","contentType":"file"},{"name":".python-version","path":".python-version","contentType":"file"},{"name":"Makefile","path":"Makefile","contentType":"file"},{"name":"README.md","path":"README.md","contentType":"file"},{"name":"docker-compose.yml","path":"docker-compose.yml","contentType":"file"},{"name":"poetry.lock","path":"poetry.lock","contentType":"file"},{"name":"pyproject.toml","path":"pyproject.toml","contentType":"file"}],"totalCount":10}},"fileTreeProcessingTime":2.827313,"foldersToFetch":[],"repo":{"id":793583549,"defaultBranch":"main","name":"FastAPI_TDD","ownerLogin":"danielmarcosvilela","currentUserCanPush":false,"isFork":false,"isEmpty":false,"createdAt":"2024-04-29T10:49:44.000-03:00","ownerAvatar":"https://avatars.githubusercontent.com/u/83494779?v=4","public":true,"private":false,"isOrgOwned":false},"codeLineWrapEnabled":false,"symbolsExpanded":true,"treeExpanded":true,"refInfo":{"name":"main","listCacheKey":"v0:1714484464.0","canEdit":true,"refType":"branch","currentOid":"aaebd12f7d696b078140cbf032144aea34ab2d40"},"path":"tests/conftest.py","currentUser":{"id":169305262,"login":"adrianobodnar","userEmail":"adrianobod@gmail.com"},"blob":{"rawLines":["import pytest","import asyncio","","from uuid import UUID","from fastapi_tdd.db.mongo import db_client","from fastapi_tdd.schemas.product import ProductIn, ProductUpdate","from fastapi_tdd.usecases.product import product_usecase","from tests.factories import product_data, products_data","from httpx import AsyncClient","","","@pytest.fixture(scope=\"session\")","def event_loop():","    loop = asyncio.get_event_loop_policy().new_event_loop()","    yield loop","    loop.close()","","","@pytest.fixture","def mongo_client():","    return db_client.get()","","","@pytest.fixture(autouse=True)","async def clear_collections(mongo_client):","    yield","    collection_names = await mongo_client.get_database().list_collection_names()","    for collection_name in collection_names:","        if collection_name.startswith(\"system\"):","            continue","","        await mongo_client.get_database()[collection_name].delete_many({})","","","@pytest.fixture","async def client() -\u003e AsyncClient:","    from fastapi_tdd.main import app","","    async with AsyncClient(app=app, base_url=\"http://test\") as ac:","        yield ac","","","@pytest.fixture","def products_url() -\u003e str:","    return \"/products/\"","","","@pytest.fixture","def product_id() -\u003e UUID:","    return UUID(\"fce6cc37-10b9-4a8e-a8b2-977df327001a\")","","","@pytest.fixture","def product_in(product_id):","    return ProductIn(**product_data(), id=product_id)","","","@pytest.fixture","def product_up(product_id):","    return ProductUpdate(**product_data(), id=product_id)","","","@pytest.fixture","async def product_inserted(product_in):","    return await product_usecase.create(body=product_in)","","","@pytest.fixture","def products_in():","    return [ProductIn(**product) for product in products_data()]","","","@pytest.fixture","async def products_inserted(products_in):","    return [await product_usecase.create(body=product_in) for product_in in products_in]"],"stylingDirectives":null,"colorizedLines":["\u003cspan class=pl-k\u003eimport\u003c/span\u003e \u003cspan class=pl-s1\u003epytest\u003c/span\u003e","\u003cspan class=pl-k\u003eimport\u003c/span\u003e \u003cspan class=pl-s1\u003easyncio\u003c/span\u003e","","\u003cspan class=pl-k\u003efrom\u003c/span\u003e \u003cspan class=pl-s1\u003euuid\u003c/span\u003e \u003cspan class=pl-k\u003eimport\u003c/span\u003e \u003cspan class=pl-v\u003eUUID\u003c/span\u003e","\u003cspan class=pl-k\u003efrom\u003c/span\u003e \u003cspan class=pl-s1\u003efastapi_tdd\u003c/span\u003e.\u003cspan class=pl-s1\u003edb\u003c/span\u003e.\u003cspan class=pl-s1\u003emongo\u003c/span\u003e \u003cspan class=pl-k\u003eimport\u003c/span\u003e \u003cspan class=pl-s1\u003edb_client\u003c/span\u003e","\u003cspan class=pl-k\u003efrom\u003c/span\u003e \u003cspan class=pl-s1\u003efastapi_tdd\u003c/span\u003e.\u003cspan class=pl-s1\u003eschemas\u003c/span\u003e.\u003cspan class=pl-s1\u003eproduct\u003c/span\u003e \u003cspan class=pl-k\u003eimport\u003c/span\u003e \u003cspan class=pl-v\u003eProductIn\u003c/span\u003e, \u003cspan class=pl-v\u003eProductUpdate\u003c/span\u003e","\u003cspan class=pl-k\u003efrom\u003c/span\u003e \u003cspan class=pl-s1\u003efastapi_tdd\u003c/span\u003e.\u003cspan class=pl-s1\u003eusecases\u003c/span\u003e.\u003cspan class=pl-s1\u003eproduct\u003c/span\u003e \u003cspan class=pl-k\u003eimport\u003c/span\u003e \u003cspan class=pl-s1\u003eproduct_usecase\u003c/span\u003e","\u003cspan class=pl-k\u003efrom\u003c/span\u003e \u003cspan class=pl-s1\u003etests\u003c/span\u003e.\u003cspan class=pl-s1\u003efactories\u003c/span\u003e \u003cspan class=pl-k\u003eimport\u003c/span\u003e \u003cspan class=pl-s1\u003eproduct_data\u003c/span\u003e, \u003cspan class=pl-s1\u003eproducts_data\u003c/span\u003e","\u003cspan class=pl-k\u003efrom\u003c/span\u003e \u003cspan class=pl-s1\u003ehttpx\u003c/span\u003e \u003cspan class=pl-k\u003eimport\u003c/span\u003e \u003cspan class=pl-v\u003eAsyncClient\u003c/span\u003e","","","\u003cspan class=pl-en\u003e@\u003cspan class=pl-s1\u003epytest\u003c/span\u003e.\u003cspan class=pl-en\u003efixture\u003c/span\u003e(\u003cspan class=pl-s1\u003escope\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026quot;session\u0026quot;\u003c/span\u003e)\u003c/span\u003e","\u003cspan class=pl-k\u003edef\u003c/span\u003e \u003cspan class=pl-en\u003eevent_loop\u003c/span\u003e():","    \u003cspan class=pl-s1\u003eloop\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-s1\u003easyncio\u003c/span\u003e.\u003cspan class=pl-en\u003eget_event_loop_policy\u003c/span\u003e().\u003cspan class=pl-en\u003enew_event_loop\u003c/span\u003e()","    \u003cspan class=pl-k\u003eyield\u003c/span\u003e \u003cspan class=pl-s1\u003eloop\u003c/span\u003e","    \u003cspan class=pl-s1\u003eloop\u003c/span\u003e.\u003cspan class=pl-en\u003eclose\u003c/span\u003e()","","","\u003cspan class=pl-en\u003e@\u003cspan class=pl-s1\u003epytest\u003c/span\u003e.\u003cspan class=pl-s1\u003efixture\u003c/span\u003e\u003c/span\u003e","\u003cspan class=pl-k\u003edef\u003c/span\u003e \u003cspan class=pl-en\u003emongo_client\u003c/span\u003e():","    \u003cspan class=pl-k\u003ereturn\u003c/span\u003e \u003cspan class=pl-s1\u003edb_client\u003c/span\u003e.\u003cspan class=pl-en\u003eget\u003c/span\u003e()","","","\u003cspan class=pl-en\u003e@\u003cspan class=pl-s1\u003epytest\u003c/span\u003e.\u003cspan class=pl-en\u003efixture\u003c/span\u003e(\u003cspan class=pl-s1\u003eautouse\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-c1\u003eTrue\u003c/span\u003e)\u003c/span\u003e","\u003cspan class=pl-k\u003easync\u003c/span\u003e \u003cspan class=pl-k\u003edef\u003c/span\u003e \u003cspan class=pl-en\u003eclear_collections\u003c/span\u003e(\u003cspan class=pl-s1\u003emongo_client\u003c/span\u003e):","    \u003cspan class=pl-k\u003eyield\u003c/span\u003e","    \u003cspan class=pl-s1\u003ecollection_names\u003c/span\u003e \u003cspan class=pl-c1\u003e=\u003c/span\u003e \u003cspan class=pl-k\u003eawait\u003c/span\u003e \u003cspan class=pl-s1\u003emongo_client\u003c/span\u003e.\u003cspan class=pl-en\u003eget_database\u003c/span\u003e().\u003cspan class=pl-en\u003elist_collection_names\u003c/span\u003e()","    \u003cspan class=pl-k\u003efor\u003c/span\u003e \u003cspan class=pl-s1\u003ecollection_name\u003c/span\u003e \u003cspan class=pl-c1\u003ein\u003c/span\u003e \u003cspan class=pl-s1\u003ecollection_names\u003c/span\u003e:","        \u003cspan class=pl-k\u003eif\u003c/span\u003e \u003cspan class=pl-s1\u003ecollection_name\u003c/span\u003e.\u003cspan class=pl-en\u003estartswith\u003c/span\u003e(\u003cspan class=pl-s\u003e\u0026quot;system\u0026quot;\u003c/span\u003e):","            \u003cspan class=pl-k\u003econtinue\u003c/span\u003e","","        \u003cspan class=pl-k\u003eawait\u003c/span\u003e \u003cspan class=pl-s1\u003emongo_client\u003c/span\u003e.\u003cspan class=pl-en\u003eget_database\u003c/span\u003e()[\u003cspan class=pl-s1\u003ecollection_name\u003c/span\u003e].\u003cspan class=pl-en\u003edelete_many\u003c/span\u003e({})","","","\u003cspan class=pl-en\u003e@\u003cspan class=pl-s1\u003epytest\u003c/span\u003e.\u003cspan class=pl-s1\u003efixture\u003c/span\u003e\u003c/span\u003e","\u003cspan class=pl-k\u003easync\u003c/span\u003e \u003cspan class=pl-k\u003edef\u003c/span\u003e \u003cspan class=pl-en\u003eclient\u003c/span\u003e() \u003cspan class=pl-c1\u003e-\u0026gt;\u003c/span\u003e \u003cspan class=pl-v\u003eAsyncClient\u003c/span\u003e:","    \u003cspan class=pl-k\u003efrom\u003c/span\u003e \u003cspan class=pl-s1\u003efastapi_tdd\u003c/span\u003e.\u003cspan class=pl-s1\u003emain\u003c/span\u003e \u003cspan class=pl-k\u003eimport\u003c/span\u003e \u003cspan class=pl-s1\u003eapp\u003c/span\u003e","","    \u003cspan class=pl-k\u003easync\u003c/span\u003e \u003cspan class=pl-k\u003ewith\u003c/span\u003e \u003cspan class=pl-v\u003eAsyncClient\u003c/span\u003e(\u003cspan class=pl-s1\u003eapp\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s1\u003eapp\u003c/span\u003e, \u003cspan class=pl-s1\u003ebase_url\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s\u003e\u0026quot;http://test\u0026quot;\u003c/span\u003e) \u003cspan class=pl-k\u003eas\u003c/span\u003e \u003cspan class=pl-s1\u003eac\u003c/span\u003e:","        \u003cspan class=pl-k\u003eyield\u003c/span\u003e \u003cspan class=pl-s1\u003eac\u003c/span\u003e","","","\u003cspan class=pl-en\u003e@\u003cspan class=pl-s1\u003epytest\u003c/span\u003e.\u003cspan class=pl-s1\u003efixture\u003c/span\u003e\u003c/span\u003e","\u003cspan class=pl-k\u003edef\u003c/span\u003e \u003cspan class=pl-en\u003eproducts_url\u003c/span\u003e() \u003cspan class=pl-c1\u003e-\u0026gt;\u003c/span\u003e \u003cspan class=pl-s1\u003estr\u003c/span\u003e:","    \u003cspan class=pl-k\u003ereturn\u003c/span\u003e \u003cspan class=pl-s\u003e\u0026quot;/products/\u0026quot;\u003c/span\u003e","","","\u003cspan class=pl-en\u003e@\u003cspan class=pl-s1\u003epytest\u003c/span\u003e.\u003cspan class=pl-s1\u003efixture\u003c/span\u003e\u003c/span\u003e","\u003cspan class=pl-k\u003edef\u003c/span\u003e \u003cspan class=pl-en\u003eproduct_id\u003c/span\u003e() \u003cspan class=pl-c1\u003e-\u0026gt;\u003c/span\u003e \u003cspan class=pl-v\u003eUUID\u003c/span\u003e:","    \u003cspan class=pl-k\u003ereturn\u003c/span\u003e \u003cspan class=pl-v\u003eUUID\u003c/span\u003e(\u003cspan class=pl-s\u003e\u0026quot;fce6cc37-10b9-4a8e-a8b2-977df327001a\u0026quot;\u003c/span\u003e)","","","\u003cspan class=pl-en\u003e@\u003cspan class=pl-s1\u003epytest\u003c/span\u003e.\u003cspan class=pl-s1\u003efixture\u003c/span\u003e\u003c/span\u003e","\u003cspan class=pl-k\u003edef\u003c/span\u003e \u003cspan class=pl-en\u003eproduct_in\u003c/span\u003e(\u003cspan class=pl-s1\u003eproduct_id\u003c/span\u003e):","    \u003cspan class=pl-k\u003ereturn\u003c/span\u003e \u003cspan class=pl-v\u003eProductIn\u003c/span\u003e(\u003cspan class=pl-c1\u003e**\u003c/span\u003e\u003cspan class=pl-en\u003eproduct_data\u003c/span\u003e(), \u003cspan class=pl-s1\u003eid\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s1\u003eproduct_id\u003c/span\u003e)","","","\u003cspan class=pl-en\u003e@\u003cspan class=pl-s1\u003epytest\u003c/span\u003e.\u003cspan class=pl-s1\u003efixture\u003c/span\u003e\u003c/span\u003e","\u003cspan class=pl-k\u003edef\u003c/span\u003e \u003cspan class=pl-en\u003eproduct_up\u003c/span\u003e(\u003cspan class=pl-s1\u003eproduct_id\u003c/span\u003e):","    \u003cspan class=pl-k\u003ereturn\u003c/span\u003e \u003cspan class=pl-v\u003eProductUpdate\u003c/span\u003e(\u003cspan class=pl-c1\u003e**\u003c/span\u003e\u003cspan class=pl-en\u003eproduct_data\u003c/span\u003e(), \u003cspan class=pl-s1\u003eid\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s1\u003eproduct_id\u003c/span\u003e)","","","\u003cspan class=pl-en\u003e@\u003cspan class=pl-s1\u003epytest\u003c/span\u003e.\u003cspan class=pl-s1\u003efixture\u003c/span\u003e\u003c/span\u003e","\u003cspan class=pl-k\u003easync\u003c/span\u003e \u003cspan class=pl-k\u003edef\u003c/span\u003e \u003cspan class=pl-en\u003eproduct_inserted\u003c/span\u003e(\u003cspan class=pl-s1\u003eproduct_in\u003c/span\u003e):","    \u003cspan class=pl-k\u003ereturn\u003c/span\u003e \u003cspan class=pl-k\u003eawait\u003c/span\u003e \u003cspan class=pl-s1\u003eproduct_usecase\u003c/span\u003e.\u003cspan class=pl-en\u003ecreate\u003c/span\u003e(\u003cspan class=pl-s1\u003ebody\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s1\u003eproduct_in\u003c/span\u003e)","","","\u003cspan class=pl-en\u003e@\u003cspan class=pl-s1\u003epytest\u003c/span\u003e.\u003cspan class=pl-s1\u003efixture\u003c/span\u003e\u003c/span\u003e","\u003cspan class=pl-k\u003edef\u003c/span\u003e \u003cspan class=pl-en\u003eproducts_in\u003c/span\u003e():","    \u003cspan class=pl-k\u003ereturn\u003c/span\u003e [\u003cspan class=pl-v\u003eProductIn\u003c/span\u003e(\u003cspan class=pl-c1\u003e**\u003c/span\u003e\u003cspan class=pl-s1\u003eproduct\u003c/span\u003e) \u003cspan class=pl-k\u003efor\u003c/span\u003e \u003cspan class=pl-s1\u003eproduct\u003c/span\u003e \u003cspan class=pl-c1\u003ein\u003c/span\u003e \u003cspan class=pl-en\u003eproducts_data\u003c/span\u003e()]","","","\u003cspan class=pl-en\u003e@\u003cspan class=pl-s1\u003epytest\u003c/span\u003e.\u003cspan class=pl-s1\u003efixture\u003c/span\u003e\u003c/span\u003e","\u003cspan class=pl-k\u003easync\u003c/span\u003e \u003cspan class=pl-k\u003edef\u003c/span\u003e \u003cspan class=pl-en\u003eproducts_inserted\u003c/span\u003e(\u003cspan class=pl-s1\u003eproducts_in\u003c/span\u003e):","    \u003cspan class=pl-k\u003ereturn\u003c/span\u003e [\u003cspan class=pl-k\u003eawait\u003c/span\u003e \u003cspan class=pl-s1\u003eproduct_usecase\u003c/span\u003e.\u003cspan class=pl-en\u003ecreate\u003c/span\u003e(\u003cspan class=pl-s1\u003ebody\u003c/span\u003e\u003cspan class=pl-c1\u003e=\u003c/span\u003e\u003cspan class=pl-s1\u003eproduct_in\u003c/span\u003e) \u003cspan class=pl-k\u003efor\u003c/span\u003e \u003cspan class=pl-s1\u003eproduct_in\u003c/span\u003e \u003cspan class=pl-c1\u003ein\u003c/span\u003e \u003cspan class=pl-s1\u003eproducts_in\u003c/span\u003e]"],"csv":null,"csvError":null,"dependabotInfo":{"showConfigurationBanner":false,"configFilePath":null,"networkDependabotPath":"/danielmarcosvilela/FastAPI_TDD/network/updates","dismissConfigurationNoticePath":"/settings/dismiss-notice/dependabot_configuration_notice","configurationNoticeDismissed":false},"displayName":"conftest.py","displayUrl":"https://github.com/danielmarcosvilela/FastAPI_TDD/blob/main/tests/conftest.py?raw=true","headerInfo":{"blobSize":"1.74 KB","deleteTooltip":"Fork this repository and delete the file","editTooltip":"Fork this repository and edit the file","ghDesktopPath":"https://desktop.github.com","isGitLfs":false,"onBranch":true,"shortPath":"0eaacd3","siteNavLoginPath":"/login?return_to=https%3A%2F%2Fgithub.com%2Fdanielmarcosvilela%2FFastAPI_TDD%2Fblob%2Fmain%2Ftests%2Fconftest.py","isCSV":false,"isRichtext":false,"toc":null,"lineInfo":{"truncatedLoc":"75","truncatedSloc":"50"},"mode":"file"},"image":false,"isCodeownersFile":null,"isPlain":false,"isValidLegacyIssueTemplate":false,"issueTemplate":null,"discussionTemplate":null,"language":"Python","languageID":303,"large":false,"planSupportInfo":{"repoIsFork":null,"repoOwnedByCurrentUser":null,"requestFullPath":"/danielmarcosvilela/FastAPI_TDD/blob/main/tests/conftest.py","showFreeOrgGatedFeatureMessage":null,"showPlanSupportBanner":null,"upgradeDataAttributes":null,"upgradePath":null},"publishBannersInfo":{"dismissActionNoticePath":"/settings/dismiss-notice/publish_action_from_dockerfile","releasePath":"/danielmarcosvilela/FastAPI_TDD/releases/new?marketplace=true","showPublishActionBanner":false},"rawBlobUrl":"https://github.com/danielmarcosvilela/FastAPI_TDD/raw/main/tests/conftest.py","renderImageOrRaw":false,"richText":null,"renderedFileInfo":null,"shortPath":null,"symbolsEnabled":true,"tabSize":8,"topBannersInfo":{"overridingGlobalFundingFile":false,"globalPreferredFundingPath":null,"showInvalidCitationWarning":false,"citationHelpUrl":"https://docs.github.com/github/creating-cloning-and-archiving-repositories/creating-a-repository-on-github/about-citation-files","actionsOnboardingTip":null},"truncated":false,"viewable":true,"workflowRedirectUrl":null,"symbols":{"timed_out":false,"not_analyzed":false,"symbols":[{"name":"event_loop","kind":"function","ident_start":342,"ident_end":352,"extent_start":338,"extent_end":447,"fully_qualified_name":"event_loop","ident_utf16":{"start":{"line_number":12,"utf16_col":4},"end":{"line_number":12,"utf16_col":14}},"extent_utf16":{"start":{"line_number":12,"utf16_col":0},"end":{"line_number":15,"utf16_col":16}}},{"name":"mongo_client","kind":"function","ident_start":470,"ident_end":482,"extent_start":466,"extent_end":512,"fully_qualified_name":"mongo_client","ident_utf16":{"start":{"line_number":19,"utf16_col":4},"end":{"line_number":19,"utf16_col":16}},"extent_utf16":{"start":{"line_number":19,"utf16_col":0},"end":{"line_number":20,"utf16_col":26}}},{"name":"clear_collections","kind":"function","ident_start":555,"ident_end":572,"extent_start":545,"extent_end":869,"fully_qualified_name":"clear_collections","ident_utf16":{"start":{"line_number":24,"utf16_col":10},"end":{"line_number":24,"utf16_col":27}},"extent_utf16":{"start":{"line_number":24,"utf16_col":0},"end":{"line_number":31,"utf16_col":74}}},{"name":"client","kind":"function","ident_start":898,"ident_end":904,"extent_start":888,"extent_end":1044,"fully_qualified_name":"client","ident_utf16":{"start":{"line_number":35,"utf16_col":10},"end":{"line_number":35,"utf16_col":16}},"extent_utf16":{"start":{"line_number":35,"utf16_col":0},"end":{"line_number":39,"utf16_col":16}}},{"name":"products_url","kind":"function","ident_start":1067,"ident_end":1079,"extent_start":1063,"extent_end":1113,"fully_qualified_name":"products_url","ident_utf16":{"start":{"line_number":43,"utf16_col":4},"end":{"line_number":43,"utf16_col":16}},"extent_utf16":{"start":{"line_number":43,"utf16_col":0},"end":{"line_number":44,"utf16_col":23}}},{"name":"product_id","kind":"function","ident_start":1136,"ident_end":1146,"extent_start":1132,"extent_end":1213,"fully_qualified_name":"product_id","ident_utf16":{"start":{"line_number":48,"utf16_col":4},"end":{"line_number":48,"utf16_col":14}},"extent_utf16":{"start":{"line_number":48,"utf16_col":0},"end":{"line_number":49,"utf16_col":55}}},{"name":"product_in","kind":"function","ident_start":1236,"ident_end":1246,"extent_start":1232,"extent_end":1313,"fully_qualified_name":"product_in","ident_utf16":{"start":{"line_number":53,"utf16_col":4},"end":{"line_number":53,"utf16_col":14}},"extent_utf16":{"start":{"line_number":53,"utf16_col":0},"end":{"line_number":54,"utf16_col":53}}},{"name":"product_up","kind":"function","ident_start":1336,"ident_end":1346,"extent_start":1332,"extent_end":1417,"fully_qualified_name":"product_up","ident_utf16":{"start":{"line_number":58,"utf16_col":4},"end":{"line_number":58,"utf16_col":14}},"extent_utf16":{"start":{"line_number":58,"utf16_col":0},"end":{"line_number":59,"utf16_col":57}}},{"name":"product_inserted","kind":"function","ident_start":1446,"ident_end":1462,"extent_start":1436,"extent_end":1532,"fully_qualified_name":"product_inserted","ident_utf16":{"start":{"line_number":63,"utf16_col":10},"end":{"line_number":63,"utf16_col":26}},"extent_utf16":{"start":{"line_number":63,"utf16_col":0},"end":{"line_number":64,"utf16_col":56}}},{"name":"products_in","kind":"function","ident_start":1555,"ident_end":1566,"extent_start":1551,"extent_end":1634,"fully_qualified_name":"products_in","ident_utf16":{"start":{"line_number":68,"utf16_col":4},"end":{"line_number":68,"utf16_col":15}},"extent_utf16":{"start":{"line_number":68,"utf16_col":0},"end":{"line_number":69,"utf16_col":64}}},{"name":"products_inserted","kind":"function","ident_start":1663,"ident_end":1680,"extent_start":1653,"extent_end":1783,"fully_qualified_name":"products_inserted","ident_utf16":{"start":{"line_number":73,"utf16_col":10},"end":{"line_number":73,"utf16_col":27}},"extent_utf16":{"start":{"line_number":73,"utf16_col":0},"end":{"line_number":74,"utf16_col":88}}}]}},"copilotInfo":{"documentationUrl":"https://docs.github.com/copilot/overview-of-github-copilot/about-github-copilot-for-individuals","notices":{"codeViewPopover":{"dismissed":false,"dismissPath":"/settings/dismiss-notice/code_view_copilot_popover"}},"userAccess":{"hasSubscriptionEnded":false,"orgHasCFBAccess":false,"userHasCFIAccess":false,"userHasOrgs":false,"userIsOrgAdmin":false,"userIsOrgMember":false,"business":null,"featureRequestInfo":null}},"copilotAccessAllowed":false,"csrf_tokens":{"/danielmarcosvilela/FastAPI_TDD/branches":{"post":"9Fth5CqUgCBM0HznpSxEnlKoir-O74EQDSuHSDXsRkkq0mbBdONR6rQwHp-GC9ZLViN6ZLgeHPjcFGI8fk1_lw"},"/repos/preferences":{"post":"KEdmIGSyRoorYJPobs_8EIOl6zYJsIugi2MEfToM5O8TC0BTh79pcjCjcll1Ilp-uPYj-mxEw-SrO6hQVs0ijA"}}},"title":"FastAPI_TDD/tests/conftest.py at main · danielmarcosvilela/FastAPI_TDD","appPayload":{"helpUrl":"https://docs.github.com","findFileWorkerPath":"/assets-cdn/worker/find-file-worker-1583894afd38.js","findInFileWorkerPath":"/assets-cdn/worker/find-in-file-worker-3a63a487027b.js","githubDevUrl":"https://github.dev/","enabled_features":{"code_nav_ui_events":false,"react_blob_overlay":true,"copilot_conversational_ux_embedding_update":false,"copilot_smell_icebreaker_ux":true,"copilot_workspace":false}}}</script>
...
<div id="LC4" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-k>from</span> <span class=pl-s1>uuid</span> <span class=pl-k>import</span> <span class=pl-v>UUID</span></div>
...
<div id="LC6" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-k>from</span> <span class=pl-s1>fastapi_tdd</span>.<span class=pl-s1>schemas</span>.<span class=pl-s1>product</span> <span class=pl-k>import</span> <span class=pl-v>ProductIn</span>, <span class=pl-v>ProductUpdate</span></div>
...
<div id="LC8" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-k>from</span> <span class=pl-s1>tests</span>.<span class=pl-s1>factories</span> <span class=pl-k>import</span> <span class=pl-s1>product_data</span>, <span class=pl-s1>products_data</span></div>
<div id="LC9" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-k>from</span> <span class=pl-s1>httpx</span> <span class=pl-k>import</span> <span class=pl-v>AsyncClient</span></div>
...
<div id="LC12" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-en>@<span class=pl-s1>pytest</span>.<span class=pl-en>fixture</span>(<span class=pl-s1>scope</span><span class=pl-c1>=</span><span class=pl-s>&quot;session&quot;</span>)</span></div>
<div id="LC13" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-k>def</span> <span class=pl-en>event_loop</span>():</div>
<div id="LC14" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">    <span class=pl-s1>loop</span> <span class=pl-c1>=</span> <span class=pl-s1>asyncio</span>.<span class=pl-en>get_event_loop_policy</span>().<span class=pl-en>new_event_loop</span>()</div>
<div id="LC15" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">    <span class=pl-k>yield</span> <span class=pl-s1>loop</span></div>
<div id="LC16" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">    <span class=pl-s1>loop</span>.<span class=pl-en>close</span>()</div>
...
<div id="LC19" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-en>@<span class=pl-s1>pytest</span>.<span class=pl-s1>fixture</span></span></div>
<div id="LC20" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-k>def</span> <span class=pl-en>mongo_client</span>():</div>
<div id="LC21" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">    <span class=pl-k>return</span> <span class=pl-s1>db_client</span>.<span class=pl-en>get</span>()</div>
...
<div id="LC24" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-en>@<span class=pl-s1>pytest</span>.<span class=pl-en>fixture</span>(<span class=pl-s1>autouse</span><span class=pl-c1>=</span><span class=pl-c1>True</span>)</span></div>
<div id="LC25" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-k>async</span> <span class=pl-k>def</span> <span class=pl-en>clear_collections</span>(<span class=pl-s1>mongo_client</span>):</div>
<div id="LC26" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-24 ">    <span class=pl-k>yield</span></div>
<div id="LC27" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-24 ">    <span class=pl-s1>collection_names</span> <span class=pl-c1>=</span> <span class=pl-k>await</span> <span class=pl-s1>mongo_client</span>.<span class=pl-en>get_database</span>().<span class=pl-en>list_collection_names</span>()</div>
<div id="LC28" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-24 ">    <span class=pl-k>for</span> <span class=pl-s1>collection_name</span> <span class=pl-c1>in</span> <span class=pl-s1>collection_names</span>:</div>
<div id="LC29" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-24 ">        <span class=pl-k>if</span> <span class=pl-s1>collection_name</span>.<span class=pl-en>startswith</span>(<span class=pl-s>&quot;system&quot;</span>):</div>
<div id="LC30" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-24 ">            <span class=pl-k>continue</span></div>
<div id="LC31" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-24 ">
</div>
<div id="LC32" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">        <span class=pl-k>await</span> <span class=pl-s1>mongo_client</span>.<span class=pl-en>get_database</span>()[<span class=pl-s1>collection_name</span>].<span class=pl-en>delete_many</span>({})</div>
...
<div id="LC35" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-en>@<span class=pl-s1>pytest</span>.<span class=pl-s1>fixture</span></span></div>
<div id="LC36" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-k>async</span> <span class=pl-k>def</span> <span class=pl-en>client</span>() <span class=pl-c1>-&gt;</span> <span class=pl-v>AsyncClient</span>:</div>
<div id="LC37" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-35 ">    <span class=pl-k>from</span> <span class=pl-s1>fastapi_tdd</span>.<span class=pl-s1>main</span> <span class=pl-k>import</span> <span class=pl-s1>app</span></div>
<div id="LC38" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-35 ">
</div>
<div id="LC39" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div child-of-line-35 ">    <span class=pl-k>async</span> <span class=pl-k>with</span> <span class=pl-v>AsyncClient</span>(<span class=pl-s1>app</span><span class=pl-c1>=</span><span class=pl-s1>app</span>, <span class=pl-s1>base_url</span><span class=pl-c1>=</span><span class=pl-s>&quot;http://test&quot;</span>) <span class=pl-k>as</span> <span class=pl-s1>ac</span>:</div>
<div id="LC40" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">        <span class=pl-k>yield</span> <span class=pl-s1>ac</span></div>
...
<div id="LC43" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-en>@<span class=pl-s1>pytest</span>.<span class=pl-s1>fixture</span></span></div>
<div id="LC44" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-k>def</span> <span class=pl-en>products_url</span>() <span class=pl-c1>-&gt;</span> <span class=pl-s1>str</span>:</div>
<div id="LC45" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">    <span class=pl-k>return</span> <span class=pl-s>&quot;/products/&quot;</span></div>
...
<div id="LC48" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-en>@<span class=pl-s1>pytest</span>.<span class=pl-s1>fixture</span></span></div>
<div id="LC49" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-k>def</span> <span class=pl-en>product_id</span>() <span class=pl-c1>-&gt;</span> <span class=pl-v>UUID</span>:</div>
<div id="LC50" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">    <span class=pl-k>return</span> <span class=pl-v>UUID</span>(<span class=pl-s>&quot;fce6cc37-10b9-4a8e-a8b2-977df327001a&quot;</span>)</div>
...
<div id="LC53" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-en>@<span class=pl-s1>pytest</span>.<span class=pl-s1>fixture</span></span></div>
<div id="LC54" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-k>def</span> <span class=pl-en>product_in</span>(<span class=pl-s1>product_id</span>):</div>
<div id="LC55" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">    <span class=pl-k>return</span> <span class=pl-v>ProductIn</span>(<span class=pl-c1>**</span><span class=pl-en>product_data</span>(), <span class=pl-s1>id</span><span class=pl-c1>=</span><span class=pl-s1>product_id</span>)</div>
...
<div id="LC58" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-en>@<span class=pl-s1>pytest</span>.<span class=pl-s1>fixture</span></span></div>
<div id="LC59" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-k>def</span> <span class=pl-en>product_up</span>(<span class=pl-s1>product_id</span>):</div>
<div id="LC60" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">    <span class=pl-k>return</span> <span class=pl-v>ProductUpdate</span>(<span class=pl-c1>**</span><span class=pl-en>product_data</span>(), <span class=pl-s1>id</span><span class=pl-c1>=</span><span class=pl-s1>product_id</span>)</div>
...
<div id="LC63" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-en>@<span class=pl-s1>pytest</span>.<span class=pl-s1>fixture</span></span></div>
<div id="LC64" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-k>async</span> <span class=pl-k>def</span> <span class=pl-en>product_inserted</span>(<span class=pl-s1>product_in</span>):</div>
<div id="LC65" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">    <span class=pl-k>return</span> <span class=pl-k>await</span> <span class=pl-s1>product_usecase</span>.<span class=pl-en>create</span>(<span class=pl-s1>body</span><span class=pl-c1>=</span><span class=pl-s1>product_in</span>)</div>
...
<div id="LC68" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-en>@<span class=pl-s1>pytest</span>.<span class=pl-s1>fixture</span></span></div>
<div id="LC69" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class=pl-k>def</span> <span class=pl-en>products_in</span>():</div>
<div id="LC70" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">    <span class=pl-k>return</span> [<span class=pl-v>ProductIn</span>(<span class=pl-c1>**</span><span class=pl-s1>product</span>) <span class=pl-k>for</span> <span class=pl-s1>product</span> <span class=pl-c1>in</span> <span class=pl-en>products_data</span>()]</div>
